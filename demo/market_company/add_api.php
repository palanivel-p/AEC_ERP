...
//    $sqlValidateCookie="SELECT * FROM `user_details` WHERE panel_api_key='$api_key'";
    ...
    if (mysqli_num_rows($resValidateCookie) > 0) {
        ...
        //Furnace lining
                ...
                $sqlInsert = "INSERT INTO `market_profile`(`market_profile_id`, `customer_name`,`material_type`,`location`,`monthly_production`,`shift`,`added_date`,`added_by`)
                                           VALUES ('','$customer_name','$material_type','$location','$monthly_production','$shift','$current_date','$added_by')";
