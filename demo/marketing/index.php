...
//                             $sql = "SELECT * FROM market ORDER BY id  LIMIT $start,10";
                            ...
                            if($product_id == "") {
                                $sql = "SELECT * FROM market WHERE visit_date  BETWEEN '$from_date' AND '$to_date'$addedBy ORDER BY id DESC LIMIT $start,10";
                            }
                            {
                                $sql = "SELECT * FROM market WHERE visit_date  BETWEEN '$from_date' AND '$to_date' $product_idSql$addedBy ORDER BY id DESC LIMIT $start,10";
                            }
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="dropdown">
                                        <a href="<?php echo $website?>/marketing/show_file.php?market_id=<?php echo $row['market_id']?>"
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            ?>
                                            <a class="dropdown-item" style="cursor: pointer" onclick="delete_model('<?php echo $row['market_id'];?>')">Delete</a>
                                                <?php
                                            }
                                            ?>
                                        </div>
                    ...
                    <div class="basic-form" style="color: black;">
                        <form id="filter_form" autocomplete="off">
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-12">
                                    <label>Product Name </label>
                                    <input type="text"  class="form-control" placeholder="Product Name" id="product_id" name="product_id" style="border-color: #181f5a;color: black">
                                </div>
    ...
    $("#expense_form").validate(
        {
            ...
            messages: {
                ...
                // material_name: "*This field is required",
