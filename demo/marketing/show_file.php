            ...
            <div class="card">
                <div class="card-body">
                    <div class="card-header">
                        <h4 class="card-title">View / Market</h4>
                        <div style="display: flex;justify-content: flex-end;">
                            <a href="<?php echo $website?>/marketing/"><button class="btn btn-danger" type="button">Close</button></a>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-12">
                                ...
                                $l_date = $row['last_follow'];
                                $last_follow = date('d-m-Y', strtotime($l_date));
                                $n_date = $row['next_follow'];
                                $next_follow = date('d-m-Y', strtotime($n_date));
                                ?>
                                <table class="table table-bordered" style="text-align: center;">
                                    ...
                                    <!--                                    </tr>-->
                                    <tr>
                                        <th class="table_head"><strong>Visit Date</strong></th>
                                        <td class="table_data"><?php echo $visite_date?></td>
                                    </tr>
                                    <tr>
                                        <th class="table_head"><strong>Customer Name</strong></th>
                                        <td class="table_data"><?php echo $row['customer_name']?></td>
                                    </tr>
                                    <tr>
                                        <th class="table_head"><strong>Meet whom</strong></th>
                                        <td class="table_data"><?php echo $row['meet_whom']?></td>
                                    </tr>

                                    <tr>
                                        <th class="table_head"><strong>Sample Given </strong></th>
                                        <td class="table_data"><?php echo $row['sample_given']?></td>
                                    </tr>
                                    <tr>
                                        <th class="table_head"><strong>Product Name</strong></th>
                                        <td class="table_data"><?php echo $row['material_name']?></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <th class="table_head"><strong>Progress </strong></th>
                                        <td class="table_data"><?php echo $row['progress']?></td>
                                    </tr>
                                    <tr>
                                        <th class="table_head"><strong>Commitment Value </strong></th>
                                        <td class="table_data"><?php echo $row['commitment_value']?></td>
                                    </tr>
                                    <tr>
                                        <th class="table_head"><strong>Commitment Quantity </strong></th>
                                        <td class="table_data"><?php echo $row['commitment_qty']?></td>
                                    </tr>
                                    <tr>
                                        <th class="table_head"><strong>Next Follow date </strong></th>
                                        <td class="table_data"><?php echo $next_follow?></td>
                                    </tr>
                                    <tr>
                                        <th class="table_head"><strong>Discussed About </strong></th>
                                        <td class="table_data"><?php echo $row['discuss_about']?></td>
                                    </tr>
                                    </tbody>
                                </table>
