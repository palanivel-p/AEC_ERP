...
<!--                                                <p class="mb-1" style="text-align: center;">Total Sale</p>-->
                        ...
                        <div class="col-xl-6 col-lg-12 col-sm-12" onclick="login('logOut')" style="margin-top: 50px;">
...
<!--                                            <p class="mb-1" style="text-align: center;">Purchase Return</p>-->
                        ...
                        <div class="col-xl-6 col-lg-12 col-sm-12" onclick="login('breakOut')" style="margin-top: 50px;">
                            <div class="widget-stat card bg-success">
                                <div class="card-body p-4">
                                    <div class="media">
                                        <div class="media-body text-white">
