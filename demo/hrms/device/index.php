                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table table-responsive-md" style="text-align: center;">
                            ...
                            <tr>
                                ...
                                <th><strong>Latest Updated</strong></th>
                            ...
                            <?php
                                ...
                                $sql = "SELECT * FROM devices ORDER BY id DESC LIMIT $start, 10";
                            ...
                            <tr>
                                ...
                                <td><?php echo $row['percentage'] . '%'; ?>-<?php echo $row['status']; ?> </td>
                                <td>  <?php
                                    $originalDateTime = $row['updated_dt'];
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item"  onclick="viewDevice(<?php echo $row['id']; ?>)">Edit</a>
                                            <a class="dropdown-item"  onclick="deleteDevice('<?php echo $row['din']; ?>')">Delete</a>
                                            <!-- <a class="dropdown-item" style="cursor: pointer" onclick="delete_model('<?php //echo $row['staff_id'];?>')">Delete</a> -->
                                        </div>
                                    </div>
                                </td>
                            ...
                            <nav>
                                <ul class="pagination pagination-gutter pagination-primary pagination-sm no-bg">
                                    ...
                                    else
                                    {
                                        ...
                                        $sql = "SELECT COUNT(id) as count FROM devices";
                    ...
                    <div class="modal-body">
                        <form id="deviceForm">
                            <div class="input-block mb-3">
                                <label class="col-form-label">Device name <span class="text-danger">*</span></label>
                                <input class="form-control" type="text" name="dname" id="dname" style="color: black">
                            ...
                            <!--                        </div>-->
                            <div class="input-block mb-3">
                                <label class="col-form-label">Device ID <span class="text-danger">*</span></label>
                                <input class="form-control" type="text" name="dinput" id="dinput" style="color: black">
                            </div>


                            <div class="submit-section">
                                <button class="btn btn-primary" type="button" id="add">Add Device</button>
                            </div>
                        </form>
                    </div>
                </div>
...
<script>
    ...
    $(document).ready(function() {
        $("#deviceForm").validate({
            ...
            messages: {
                dname: "Please enter a name for the device.",
                dinput: "Please provide Unique ID for the device.",
            }
        });
    });
