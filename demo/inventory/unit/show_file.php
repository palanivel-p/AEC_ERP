                ...
                <div class="card-body">
                    <div class="card-header">
                        ...
                        <div style="display: flex;justify-content: flex-end;">
                            <a href="<?php echo $website?>/inventory/unit/"><button class="btn btn-danger" type="button">Close</button></a>
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <table class="table table-bordered" style="text-align: center;">
                                    <tbody>
                                    <tr>
                                        <th><strong>Unit ID</strong></th>
                                        <td><strong><?php echo $unit_id;?></strong></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        if($operation_value==0){
                                            ...
                                            $operation_value1=$operation_value;
                                        }
                                        ?>
                                        <td><?php echo $operation_value1?></td>
...
<script>
    ...
    var liElement = document.getElementById("active8");
    var aElement = document.getElementById("link8");
