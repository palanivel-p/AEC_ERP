                ...
                <div class="card-body">
                    <div class="card-header">
                        ...
                        <div style="display: flex;justify-content: flex-end;">
                            <a href="<?php echo $website?>/inventory/product/"><button class="btn btn-danger" type="button">Close</button></a>
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <table class="table table-bordered" style="text-align: center;">
                                    ...
                                    <tr>
                                        <th><strong>Stock Alert</strong></th>
                                        <td><?php echo $row['stock_alert']?></td>
                                    </tr>
                                    <tr>
                                        <th><strong>Tax (%)</strong></th>
                                        <td><?php echo $row['order_tax']?>%</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        if($img==1){
                                            ...
                                            ?>
                                        <td><img src="<?php echo $website?>/inventory/product/product_img/<?php echo $product_id ?>.jpg" alt="Company Logo" style="width: 150px;"></td>
                                       <?php
                                        }
                                        else if($img==0){
                                            $img1="NA";
...
<script>
    ...
    var liElement = document.getElementById("active5");
    var aElement = document.getElementById("link5");
