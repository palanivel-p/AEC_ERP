...
$objPHPExcel->getActiveSheet()->setCellValue('N2', 'Purchase Unit');
$objPHPExcel->getActiveSheet()->setCellValue('O2', 'Stock Alert');
$objPHPExcel->getActiveSheet()->setCellValue('P2', 'Order Tax');
$objPHPExcel->getActiveSheet()->setCellValue('Q2', 'Tax Type');
$objPHPExcel->getActiveSheet()->setCellValue('R2', 'Description');
$i = 0;
...
//        $product_price =  $row['product_price'];
        ...
        $objPHPExcel->getActiveSheet()->setCellValue('G' . ($i + 2) ,$sub_category);
        $objPHPExcel->getActiveSheet()->setCellValue('H' . ($i + 2) ,$brand_type);
        ...
        $objPHPExcel->getActiveSheet()->setCellValue('O' . ($i + 2) ,$stock_alert);
        $objPHPExcel->getActiveSheet()->setCellValue('P' . ($i + 2) ,$order_tax);
        $objPHPExcel->getActiveSheet()->setCellValue('Q' . ($i + 2) ,$tax_type);
        $objPHPExcel->getActiveSheet()->setCellValue('R' . ($i + 2) ,$description);
