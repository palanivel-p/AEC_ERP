                ...
                <div class="card-body">
                    <div class="card-header">
                        ...
                        <div style="display: flex;justify-content: flex-end;">
                            <a href="<?php echo $website?>/inventory/brand/"><button class="btn btn-danger" type="button">Close</button></a>
                            ...
                            <div class="col-12">
                                ...
                                <table class="table table-bordered" style="text-align: center;">
                                    ...
                                    <tr>
                                        ...
                                        <td><strong><?php echo $brand_id;?></strong></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        if($img==1){
                                            ...
                                            ?>
                                        <td><img src="<?php echo $website?>/inventory/brand/brand_img/<?php echo $brand_id ?>.jpg" alt="Company Logo" style="width: 150px;"></td>
                                       <?php
                                        }
                                        else if($img==0){
                                            $img1="NA";
...
<script>
    ...
    var liElement = document.getElementById("active7");
    var aElement = document.getElementById("link7");
