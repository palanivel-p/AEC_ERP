...
//                                $sql = "SELECT * FROM purchase  ORDER BY id  LIMIT $start,10";
    $sql = "SELECT * FROM sale_return WHERE return_date  BETWEEN '$from_date' AND '$to_date'";
}
else {
    $sql = "SELECT * FROM sale_return WHERE id > 0 WHERE return_date  BETWEEN '$from_date' AND '$to_date' $pur_idSql";
}
...
ob_clean();
$objPHPExcel->getActiveSheet()->setCellValue('A1'," Sale_return List");
//$objPHPExcel->getActiveSheet()->setCellValue('A2');
