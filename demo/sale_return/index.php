                ...
                <div class="card-body">
                    <div class="table-responsive">
                        ...
                        <table class="table table-responsive-md" style="text-align: center;">
                            ...
                            <?php
                            if($pur_id == "" ) {
//                                $sql = "SELECT * FROM sale  ORDER BY id  LIMIT $start,10";
                                $sql = "SELECT * FROM sale_return WHERE return_date  BETWEEN '$from_date' AND '$to_date' ORDER BY id DESC LIMIT $start, 10";

                            }
                            else {
                                $sql = "SELECT * FROM sale_return WHERE return_date  BETWEEN '$from_date' AND '$to_date' $pur_idSql ORDER BY id DESC LIMIT $start,10";
                            }
                            ...
                            $Supplier =  $rowSupplier['customer_name'];
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="dropdown">
                                        <a href="<?php echo $website?>/sale_return/show_file.php?return_id=<?php echo $return_id?>"
                                           class="btn btn-primary shadow btn-xs sharp me-1"><i class="fa fa-eye"></i></a>
                                    </div>
                                </td>
                                <td>
                                    <a class="btn btn-primary" href="<?php echo $website; ?>/sale_return_details?return_id=<?php echo $return_id?>" role="button">Return Product</a>
                                </td>
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            <a class="dropdown-item" data-toggle="modal" data-target="#repayment_list" style="cursor: pointer" onclick="repayment('<?php echo $return_id?>','<?php echo $row['sale_id']?>','<?php echo $row['grand_total']?>','<?php echo $totalAmount?>','<?php echo $balance_amount?>')">Create Payment</a>
                                        </div>
                                    </div>
                                </td>
                        ...
                        <div class="col-12 pl-3" style="display: flex;justify-content: center;">
                            <nav>
                                <ul class="pagination pagination-gutter pagination-primary pagination-sm no-bg">
                                    ...
                                    //                                    $sql = "SELECT COUNT(id) as count FROM sale_return";

                                    if($pur_id == "" ) {
//                                $sql = "SELECT * FROM sale  ORDER BY id  LIMIT $start,10";
                                        $sql = "SELECT COUNT(id) as count FROM sale_return WHERE return_date  BETWEEN '$from_date' AND '$to_date'$addedBy";

                                    }
                                    else {
                                        $sql = "SELECT COUNT(id) as count FROM sale_return WHERE return_date  BETWEEN '$from_date' AND '$to_date' $pur_idSql$addedBy";
                                    }
                                    $result = mysqli_query($conn, $sql);
                            ...
                            <form id="sale_form" autocomplete="off">
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="hidden" class="form-control" placeholder="sale Id" id="p_id" name="p_id" value="<?php echo $sale_id?>">                                  <input type="hidden" class="form-control"  id="old_pa_id" name="old_pa_id">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="basic-form" style="color: black;">
                            <form id="status_form" autocomplete="off">
                                ...
                                <?php
                                $pusrchase_sts = $_GET['sale_sts'];

                                $sql = "SELECT * FROM sale_details WHERE sale_id = '$pusrchase_sts'";
                                $result = mysqli_query($conn, $sql);
                                if (mysqli_num_rows($result)>0) {
                                    $sNo = 1;
                                    while($row = mysqli_fetch_assoc($result)) {
                                        ...
                                        $sqlSubCategory = "SELECT * FROM `sale` WHERE `sale_id`='$pusrchase_sts'";
...
<script>
    ...
    //     }
    // });
    function repayment(return_id,saleid,gtotal,pamount,damount) {
