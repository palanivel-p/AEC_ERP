            ...
            <div class="card">
                <div class="card-body">
                    <div class="card-header">
                        <h4 class="card-title">View / Sale Return</h4>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <?php
                                  ...
                                  $sql = "SELECT * FROM sale_return WHERE return_id='$return_id'";
                                ...
                                $sqlamount="SELECT SUM(pay_made) AS pay_made  FROM sale_payment WHERE sale_id='$s_id'";
                                ...
                                <table class="table table-bordered dom" style="text-align: center;">
                                    ...
                                    <tr>
                                        ...
                                        <td><strong><?php echo $s_id;?></strong></td>
                                    </tr>
                                    <tr>
...
<!--                                        <th class="table_head"><strong>Product code</strong></th>-->
                                    ...
                                    <tbody>
                                    <?php
                                    $sql = "SELECT * FROM sale_return_details WHERE sale_id ='$s_id'";
                                    $result = mysqli_query($conn, $sql);
