...
<div id="main-wrapper">
    ...
    <?php
    $header_name ="All sale Order profile";
            ...
            <div class="card">
                <div class="card-body">
                    <div class="card-header">
                        <h4 class="card-title">View / All sale Order profile</h4>
                        <div style="display: flex;justify-content: flex-end;">
                            <a href="<?php echo $website?>/so/all_so.php"><button class="btn btn-danger" type="button">Close</button></a>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <?php
                                  ...
                                  $sql = "SELECT * FROM so WHERE so_id='$so_id'";
                                ...
                                $po_date = date('d-m-Y', strtotime($date1));
                                ...
                                <table class="table table-bordered dom" style="text-align: center;">
                                    ...
                                    <tr>
                                        ...
                                        <td><strong><?php echo $so_id;?></strong></td>
                                    </tr>
                                    <tr>
                                        <th class="table_head"><strong>So Date</strong></th>
                                        <td class="table_data"><?php echo $so_date?></td>
                                    </tr>
                                    <tr>
                                        <th class="table_head"><strong>PO No</strong></th>
                                        <td class="table_data"><?php echo $row['po_no']?></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="table_data"><?php echo $row['po_date']?></td>
                                    </tr>
                                    <tr>
                                        <th class="table_head"><strong>Payment terms</strong></th>
                                        <td class="table_data"><?php echo $row['payment_terms']?></td>
                                    </tr>
                                    <tr>
                                        <th class="table_head"><strong>Due Date</strong></th>
                                        <td class="table_data"><?php echo $due_date?></td>
                                    </tr>
                                    <tr>
                                        <?php
                                        ...
                                        <td class="table_data"><?php echo $discount1;?></td>
                                    </tr>

                                    <tr>
                                        <th class="table_head"><strong>Total Tax</strong></th>
                                        <td class="table_data"><?php echo $row['total_tax']?></td>
                                    </tr>
                                    <tr>
                                        <th class="table_head"><strong>Grand Total</strong></th>
                                        <td class="table_data"><?php echo $row['grand_total']?></td>
                                    </tr>
                                    <tr>
                                        <?php
                                    ...
                                    <tr>
                                        ...
                                        <td class="table_data"><?php echo $row['payment_status']?></td>
                                    </tr>
                                    <tr>
                                        <?php
                                        $notes=$row['notes'];
                                        ...
                                        <td class="table_data"><?php echo $notes1?></td>
                                    </tr>
                            ...
                            <div class="col-12">
                                <table class="table table-bordered" style="text-align: center;">
                                    ...
                                    <tr>
                                        ...
                                        <th class="table_head"><strong>Product price</strong></th>
                                        <th class="table_head"><strong>Stock</strong></th>
                                        <th class="table_head"><strong>Base Unit</strong></th>
                                        <th class="table_head"><strong>Quantity</strong></th>
                                        <th class="table_head"><strong>Dis(%)</strong></th>
                                        <th class="table_head"><strong>Dis Value</strong></th>
...
//                                                    $discount_s=  str_replace("%","",$discount1);
                                            ...
                                            $unit_price =  $rowProduct['product_price'];
                                            ?>
                                            <tr>
                                                <td><strong><?php echo $so_id; ?></strong></td>
                                                <td class="table_data"><?php echo $row['product_name']; ?></td>
                                                <td class="table_data"><?php echo $unit_price; ?></td>
                                                ...
                                                <td class="table_data"><?php echo $discount1; ?></td>
                                                <td class="table_data"><?php echo $discount_value; ?></td>
                                                <td class="table_data"><?php echo $tax; ?></td>
                                                <td class="table_data"><?php echo $tax_value; ?></td>
...
<script>
    ...
    var liElement = document.getElementById("active22");
    var aElement = document.getElementById("link22");
