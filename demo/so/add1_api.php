...
//    $added_by = 'test';
    ...
    if (mysqli_num_rows($resValidateCookie) > 0) {
        ...
        $sqlInsert = "INSERT INTO `so`(`so_id`,`so_date`,`discount`,`grand_total`,`notes`,`total_tax`,`added_by`) 
                                            VALUES ('','$so_date','$discount','$grand_total','$notes','$totaltax','$added_by')";
        ...
        $sqlUpdate = "UPDATE so SET so_id = '$so_id' WHERE id ='$ID'";
...
//            $discount = str_replace('%', '', $discount);
            ...
            $sqlInsersts = "INSERT INTO so_details (so_details_id,product_id,product_name,unit,unit_cost, stock,Stock_count ,discount,dis_symbl, tax, sub_total,qty,tax_value,discount_value,discount_type,reasonType) 
                    VALUES ('','$productId','$productName','$unit', '$netUnitCost', '$stockValue','$stock_add', '$discount','$persymbl', '$tax', '$subtotal','$quantity','$tax_value','$discount_value','$symbl','$reasonType')";
            ...
            $so_details_id = "SOD" . ($ID);
            $sqlUpdate = "UPDATE so_details SET so_details_id = '$so_details_id',so_id='$so_id',so_date='$so_date' WHERE id ='$ID'";
            mysqli_query($conn, $sqlUpdate);
        ...
        $json_array['msg'] = " SO Raised successfully !!!";
