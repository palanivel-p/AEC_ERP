        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">SO Details</h4>
                ...
                <div class="card-body">
                    <div class="table-responsive" style="padding-bottom:65px" >
                        ...
                        <table class="table table-responsive-md" style="text-align: center;">
                            ...
                            $sql = "SELECT * FROM sale_details WHERE sale_id = '$sale_id'$addedBy  ORDER BY id DESC LIMIT $start, 10";
                        ...
                        <div class="col-12 pl-3" style="display: flex;justify-content: center;">
                            <nav>
                                <ul class="pagination pagination-gutter pagination-primary pagination-sm no-bg">
                                    ...
                                    $sql = "SELECT COUNT(id) as count FROM sale_details WHERE sale_id = '$sale_id'$addedBy";
