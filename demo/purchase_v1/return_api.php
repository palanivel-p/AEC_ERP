...
if(isset($_POST['supplier'])&&isset($_POST['purchase_date'])) {
    ...
    if (mysqli_num_rows($resValidateCookie) > 0) {
        ...
        //purchase_v1 return update
        $purchaseU_tt = $Purchase_total_tax - $totaltax;
        $purchaseU_gt = $Purchase_grand_total - $grand_total;

        $sqlUpdateP = "UPDATE purchase_v1 SET total_tax = '$purchaseU_tt',grand_total='$purchaseU_gt' WHERE purchase_id ='$purchase_id'";
