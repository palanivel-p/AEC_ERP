...
<!--                                <th><strong>Received Status</strong></th>-->
                            ...
                            <?php
                            if($pur_id == "" ) {
//                                $sql = "SELECT * FROM purchase_v1  ORDER BY id  LIMIT $start,10";
                                $sql = "SELECT * FROM purchase_v1 WHERE purchase_date  BETWEEN '$from_date' AND '$to_date' ORDER BY id DESC LIMIT $start, 10";

                            }
                            else {
                                $sql = "SELECT * FROM purchase_v1 WHERE id > 0 AND purchase_date  BETWEEN '$from_date' AND '$to_date' $pur_idSql ORDER BY id DESC LIMIT $start,10";
                            }
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            <a class="dropdown-item" href="https://erp.aecindia.net/purchase/edit.php?purchase_id=<?php echo $purchase_id?>" style="cursor: pointer" >Edit</a>
<!--                                            <a class="dropdown-item" href="https://erp.aecindia.net/email/index.php?purchase_id=--><?php //echo $purchase_id?><!--" style="cursor: pointer" >email</a>-->
                                            <a class="dropdown-item" href="https://erp.aecindia.net/purchase/return.php?purchase_id=<?php echo $purchase_id?>" style="cursor: pointer" >Return</a>
...
//                                    $sql = "SELECT COUNT(id) as count FROM purchase_v1";

                                    if($pur_id == "" ) {
//                                $sql = "SELECT * FROM purchase_v1  ORDER BY id  LIMIT $start,10";
                                        $sql = "SELECT COUNT(id) as count FROM purchase_v1 WHERE purchase_date  BETWEEN '$from_date' AND '$to_date'";

                                    }
                                    else {
                                        $sql = "SELECT COUNT(id) as count FROM purchase_v1 WHERE id > 0 AND purchase_date  BETWEEN '$from_date' AND '$to_date' $pur_idSql";
                                    }
                                    $result = mysqli_query($conn, $sql);
                                    ...
                                    <div class="form-group col-md-6" id="ref_nos_c">
                                        ...
                                        <select  class="form-control" id="ref_no_c" name="ref_no_c" style="border-color: #181f5a;color: black;text-transform: uppercase;">
                                            <option value="">Select Cheque No</option>
                                                <?php
                                                $sqlCheque = "SELECT * FROM `cheque_list` WHERE cheque_status = 0";
...
<!--                                        <input type="hidden" class="form-control prs_id"  id="prs_id" name="prs_id"  value="--><?php //echo $pusrchase_sts ?><!--">-->
                                    </div>
                                ...
                                $sNo++;
                                   $product_id = $row['product_id'];
                                    ...
                                    $sqlSubCategory = "SELECT * FROM `purchase_v1` WHERE `purchase_id`='$pusrchase_sts'";
...
<script>
    ...
    document.getElementById("closeButton").addEventListener("click", function() {
        window.location.href = "/all_purchase.php";
    });
    //Status
    function status_fun(data) {
            window.location.href="../purchase_v1/all_purchase.php?purchase_sts="+data;
    }
    //status close
