                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            <a class="dropdown-item" data-toggle="modal" data-target="#repayment_list" style="cursor: pointer" onclick="repayment('<?php echo $row['shipping_id'];?>','<?php echo $row['grand_total']?>','<?php echo $totalAmount?>','<?php echo $balance_amount?>')">Create Payment</a>
