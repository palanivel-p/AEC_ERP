...
if(isset($_POST['intend_id'])) {
    ...
    if (mysqli_num_rows($resValidateCookie) > 0) {
           ...
           $sqlUpdate = "UPDATE `intend` SET `intend_id`='$intend_id',`intend_date`='$intend_date',`notes`='$notes',`added_by`='$added_by' WHERE `intend_id`='$intend_id'";
        mysqli_query($conn, $sqlUpdate);

          $sqlDelete = "DELETE FROM intend_details WHERE intend_id = '$intend_id'";
...
//            }
            ...
            $sqlInsersts = "INSERT INTO intend_details (intend_details_id,intend_id,product_name,product_id, stock,qty,reasonType,base_unit) 
                    VALUES ('','$intend_id','$productName', '$productId', '$stock','$quantity','$reasonType','$unit')";
            ...
            $intend_details_id = "ID" . ($ID);
                  $sqlUpdate = "UPDATE intend_details SET intend_details_id = '$intend_details_id' WHERE id ='$ID'";
            mysqli_query($conn, $sqlUpdate);
