...
//            $sqlValidate = "SELECT * FROM `product` WHERE product_name LIKE '%$product_id%' OR product_varient LIKE '%$product_id%'";
        $sqlValidate = "SELECT DISTINCT product_name, product_code,product_varient, product_id, product_cost, stock_qty, order_tax, product_unit,brand_type FROM `product` WHERE product_name LIKE '%$product_id%' OR product_code LIKE '%$product_id%'";
//        $sqlValidate = "SELECT DISTINCT product_name, product_code, product_varient, product_id, product_price, stock_qty, order_tax, product_unit, brand_type FROM `product` WHERE (product_name LIKE '%$product_id%' OR product_code LIKE '%$product_id%') AND Stock_count != 0";
