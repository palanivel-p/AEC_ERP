                        ...
                        <form id="q1_form">
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="number" class="form-control" placeholder="Furnace Dimensions" id="furnace" name="furnace" value="<?php echo $furnace_no?>" style="border-color: #181f5a;color: black">
                                </div>
                                <div class="form-group col-md-4">
                                    <label>Former Dimensions </label>
                                    <input type="number" class="form-control" placeholder="Former Dimensions" id="former" name="former" value="<?php echo $former?>" style="border-color: #181f5a;color: black">
                                </div>
                                <div class="form-group col-md-4">
                ...
                <div class="card-body">
                    ...
                    <div class="basic-form" style="color: black;">
                        <form id="q1_form">
                            ...
                            <section class="review-section information">
                                <div class="review-header text-center">
                                    <h3 class="review-title" style="width:100%">SIDE LINING</h3>
