                ...
                <div class="card-body">
                    <div class="card-header">
                        ...
                        <div style="display: flex;justify-content: flex-end;">
                            <a href="<?php echo $website?>/service/"><button class="btn btn-danger" type="button">Close</button></a>
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <table class="table table-bordered" style="text-align: center;">
                                    ...
                                    <tr>
                                        <th class="table_head"><strong>Mobile </strong></th>
                                        <td class="table_data"><?php echo $row['mobile']?></td>
                                    </tr>
                                    ...
                                    <tr>
                                        <th class="table_head"><strong>Service Type </strong></th>
                                        <td class="table_data"><?php echo $row['service_type']?></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <th><strong>Service Image </strong></th>
                                        <?php
                                        if($img==1){

                                            ?>
                                            <td><img src="<?php echo $website?>/service/service_img/<?php echo $service_id ?>.jpg" alt="Service Logo" style="width: 150px;"></td>
                                            <?php
                                        }
                                        else if($img==0){
                                            $img1="NA";
