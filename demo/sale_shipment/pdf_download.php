...
<!--<table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">-->
    <h2 style="text-align: center">Sale Delivery challan </h2>
...
<script>
    ...
    if(timesPdf == 0){
        ...
        var opt = {
            margin:       0.5,
            filename:     'sale Delivery challan.pdf',
    ...
    setTimeout(() => {
        window.location.href = "<?php echo $website; ?>/sale_shipment/";
    }, 800);
