                ...
                <div class="card-body">
                    <div class="table-responsive">
                        ...
                        <table class="table table-responsive-md" style="text-align: center;">
                            ...
                            if($search == "") {
                                $sql = "SELECT * FROM role  ORDER BY id DESC LIMIT $start,10";
                            }
                            else {
                                $sql = "SELECT * FROM role WHERE role_name LIKE '%$search%' ORDER BY id DESC LIMIT $start,10";
                            }
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            <a class="dropdown-item" data-toggle="modal" data-target="#career_list" style="cursor: pointer" onclick="editTitle('<?php echo $row['role_id'];?>')">Edit</a>
                                            <a class="dropdown-item" style="cursor: pointer" onclick="delete_model('<?php echo $row['role_id'];?>')">Delete</a>
                        ...
                        <div class="col-12 pl-3" style="display: flex;justify-content: center;">
                            <nav>
                                <ul class="pagination pagination-gutter pagination-primary pagination-sm no-bg">
                                    ...
                                    if($search == "") {
                                        $sql = "SELECT COUNT(id) as count FROM role ";
                                    }
                                    else {
                                        $sql = "SELECT COUNT(id) as count FROM role WHERE role_name LIKE '%$search%'";
                                    }
                            ...
                            <form id="staff_form" autocomplete="off">
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="text" class="form-control" placeholder="Role Name" id="role_name" name="role_name" style="border-color: #181f5a;color: black">
       ...
       $.ajax({
           ...
           success: function(res){
               if(res.status=='success')
               {
                   ...
                   $("#old_pa_id").val(res.role_id);
                   $("#role_id").val(res.role_id);


                   var edit_model_title = "Edit Role - "+data;
