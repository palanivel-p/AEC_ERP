                ...
                <div class="card-body">
                    <div class="card-header">
                        ...
                        <div style="display: flex;justify-content: flex-end;">
                            <a href="<?php echo $website?>/People/Users/"><button class="btn btn-danger" type="button">Close</button></a>
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <table class="table table-bordered" style="text-align: center;">
                                    ...
                                    <tr>
                                        <th><strong>Eligible Leave Per Month</strong></th>
                                    ...
                                    <tr>
                                        <th><strong>User Image </strong></th>
                                        <?php
                                        if($img==1){

                                            ?>
                                        <td><img src="<?php echo $website?>/People/Users/user_img/<?php echo $user_id ?>.jpg" alt="user image" style="width: 150px;"></td>
                                       <?php
                                        }
                                        else if($img==0){
                                            $img1="NA";
