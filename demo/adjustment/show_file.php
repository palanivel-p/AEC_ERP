...
<div id="main-wrapper">
    ...
    <?php
    $header_name ="Adjustment profile";
            ...
            <div class="card">
                <div class="card-body">
                    <div class="card-header">
                        <h4 class="card-title">View / Adjustment profile</h4>
                        <div style="display: flex;justify-content: flex-end;">
                            <a href="<?php echo $website?>/adjustment/all_adjustment.php"><button class="btn btn-danger" type="button">Close</button></a>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <?php
                                  ...
                                  $sql = "SELECT * FROM adjustment WHERE adjustment_id='$adjustment_id'";
                                ...
                                <table class="table table-bordered dom" style="text-align: center;">
                                    ...
                                    <tr>
                                        ...
                                        <td><strong><?php echo $adjustment_id;?></strong></td>
                                    </tr>
                                    <tr>
                                        <th class="table_head"><strong>Adjustment Date</strong></th>
                                        <td class="table_data"><?php echo $adjusment_date?></td>
                                    </tr>
                                    <tr>
                                        <?php
                                        $notes=$row['notes'];
                                    ...
                                    <tr>
                                        ...
                                        <td class="table_data"><?php echo $row['reason']?></td>
                                    </tr>
                            ...
                            <div class="col-12">
                                <table class="table table-bordered" style="text-align: center;">
                                    ...
                                    <tr>
                                        ...
                                        <th class="table_head"><strong>Type</strong></th>
                                        <th class="table_head"><strong>Reason</strong></th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    ...
                                    if (mysqli_num_rows($result) > 0) {
                                        ...
                                        while ($row = mysqli_fetch_assoc($result)) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="table_data"><?php echo $row['base_unit']; ?></td>
                                                <td class="table_data"><?php echo $row['qty']; ?></td>
                                                <td class="table_data"><?php echo $row['adjustment_type']; ?></td>
                                                <td class="table_data"><?php echo $row['reason']; ?></td>
                                            </tr>
                                            <?php
                                        }
