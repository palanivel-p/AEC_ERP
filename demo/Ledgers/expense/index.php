                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6" id="c_type">
                                    ...
                                    <select  class="form-control" id="category_type" name="category_type" style="border-color: #181f5a;color: black">
                                        ...
                                        $sqlBrand_id = "SELECT DISTINCT expense_type FROM `expense`";
                                        ...
                                        if (mysqli_num_rows($resultBrand_id) > 0) {
                                            while ($rowBrand_id = mysqli_fetch_array($resultBrand_id)) {
                                                ...
                                                $expense_type_id =  $rowBrand_id['expense_type'];

                                                $sqlBrandName = "SELECT * FROM `expense_category` WHERE `category_id`='$expense_type_id'";
                                                $resBrandName = mysqli_query($conn, $sqlBrandName);
                                                $rowBrandName = mysqli_fetch_assoc($resBrandName);
                                                $BrandName =  $rowBrandName['category_name'];
                                                ?>
                                                <option
                                                        value='<?php echo $expense_type_id; ?>'><?php echo strtoupper($BrandName); ?></option>
                                                <?php
                                            }
                                        }
                                        ?>
