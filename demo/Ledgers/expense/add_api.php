...
if(isset($_POST['expense_date'])&& isset($_POST['amount'])) {
    ...
    if (mysqli_num_rows($resValidateCookie) > 0) {
        ...
        if (mysqli_num_rows($resValidateCheque) > 0) {
            ...
            $sqlInsert = "INSERT INTO `expense`(`expense_id`, `expense_type`,`expense_date`,`amount`,`details`,`credit_days`,`payment_mode`,`supplier`,`ref_no_c`,`reference_no`,`due_date`,`payment_status`,`added_by`) 
                                            VALUES ('','$expense_type','$expense_date','$amount','$details','$credit_days','$payment_mode','$supplier','$ref_no_c','$reference_no','$due_date','$payment_status','$added_by')";
