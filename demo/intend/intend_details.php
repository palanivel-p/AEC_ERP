        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Intend Details</h4>
...
//                            }
                            ...
                            $sql = "SELECT * FROM purchase_details WHERE purchase_id = '$purchase_id'$addedBy  ORDER BY id DESC LIMIT $start, 10";
                        ...
                        <div class="col-12 pl-3" style="display: flex;justify-content: center;">
                            <nav>
                                <ul class="pagination pagination-gutter pagination-primary pagination-sm no-bg">
                                    ...
                                    $sql = "SELECT COUNT(id) as count FROM purchase_details WHERE purchase_id = '$purchase_id'$addedBy";
