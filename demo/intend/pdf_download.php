...
<!--<table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">-->
    ...
    <table id="example">
        ...
        <?php
        if($pur_id == "" ) {
            $sql = "SELECT * FROM intend WHERE intend_date  BETWEEN '$from_date' AND '$to_date' AND request = 1 ORDER BY id DESC";
        }
        else {
            $sql = "SELECT * FROM intend WHERE intend_date  BETWEEN '$from_date' AND '$to_date' $pur_idSql AND request = 1 ORDER BY id DESC";
        }
