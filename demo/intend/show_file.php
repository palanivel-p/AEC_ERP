            ...
            <div class="card">
                <div class="card-body">
                    <div class="card-header">
                        <h4 class="card-title">View / Intend profile</h4>
                        <div style="display: flex;justify-content: flex-end;">
                            <a href="<?php echo $website?>/intend/all_intend.php"><button class="btn btn-danger" type="button">Close</button></a>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <?php
                                  ...
                                  $sql = "SELECT * FROM intend WHERE intend_id='$intend_id'";
                                ...
                                <table class="table table-bordered dom" style="text-align: center;">
                                    ...
                                    <tr>
                                        ...
                                        <td><strong><?php echo $intend_id;?></strong></td>
                                    </tr>
                                    <tr>
                                        <th class="table_head"><strong>Intend Date</strong></th>
                                        <td class="table_data"><?php echo $intend_date?></td>
                                    </tr>
                                    <tr>
                                    ...
                                    if (mysqli_num_rows($result) > 0) {
                                        ...
                                        while ($row = mysqli_fetch_assoc($result)) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="table_data"><?php echo $row['unit']; ?></td>
                                                <td class="table_data"><?php echo $row['qty']; ?></td>
                                                <td class="table_data"><?php echo $row['reasonType']; ?></td>
                                            </tr>
                                            <?php
                                        }
                                    }
...
<script>
    ...
    var liElement = document.getElementById("active17");
    var aElement = document.getElementById("link17");
