...
//    $added_by = $_COOKIE['user_id'];
    ...
    if (mysqli_num_rows($resValidateCookie) > 0) {
        ...
        $sqlInsert = "INSERT INTO `company_profile`(`company_id`, `company_name`,`phone`,`email`,`address`,`state`,`gstin`,`bank_name`,`account_name`,`account_no`,`ifsc_code`,`branch_name`) 
                                            VALUES ('','$company_name','$phone','$email','$address','$state','$gstin','$bank_name','$account_name','$account_no','$ifsc_code','$branch_name')";
