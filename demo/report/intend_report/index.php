...
//                                    if($pur_id == "" ) {
//                                        // $sql = "SELECT * FROM purchase  ORDER BY id  LIMIT $start,10";
//                                        $sql = "SELECT COUNT(id) as count FROM purchase_details WHERE purchase_date  BETWEEN '$from_date' AND '$to_date'";
//
//                                    }
//                                    else {
//                                        $sql = "SELECT COUNT(id) as count FROM purchase_details WHERE purchase_date  BETWEEN '$from_date' AND '$to_date' $pur_idSql";
//                                    }
//                                    $result = mysqli_query($conn, $sql);
//
//
