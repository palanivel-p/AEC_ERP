...
//                                    $sql = "SELECT COUNT(id) as count FROM sale";
                                    //                                    if($pur_id == "" ) {
                            ...
                            <form id="repayment_form" autocomplete="off">
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6" id="pay_mades">
                                        <label>Sale ID</label>
                                        <input type="text" class="form-control" placeholder="Sale Id" id="saleid" name="saleid" style="border-color: #181f5a;color: black">
                                    </div>
