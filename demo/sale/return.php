...
$e_way =  $rowPurchase['e_way'];
$po_no =  $rowPurchase['po_no'];
$po_date =  $rowPurchase['po_date'];
...
<head>
    ...
    <title>Return Purchase profile</title>
    ...
    <div class="content-body">
        <div class="page-titles" style="margin-left: 21px;">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="javascript:void(0)">Return Purchase</a></li>
                        ...
                        <form id="staff_form" autocomplete="off">
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="date" class="form-control" id="sale_date" name="sale_date" value="<?php echo $sale_date?>" style="border-color: #181f5a;color: black;text-transform: uppercase">
                                    <input type="hidden" class="form-control"  id="api" name="api">
                                    <input type="hidden" class="form-control"  id="old_pa_id" name="old_pa_id">
                                    <input type="hidden" class="form-control"  id="sale_id" name="sale_id" value="<?php echo $sale_id?>">
                                    <input type="hidden" class="form-control"  id="add_id" name="add_id" value="0">
                                </div>
                                <div class="form-group col-md-4">
                                    <label> PO No *</label>
                                    <input type="text" class="form-control"  placeholder="PO_No" id="po_no" name="po_no" value="<?php echo $po_no?>" style="border-color: #181f5a;color: black;text-transform: uppercase">
                                </div>
                                <div class="form-group col-md-4">
                                    <label> PO Date *</label>
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <select data-search="true" class="form-control tail-select w-full" id="customer" name="customer" style="border-color: #181f5a; color: black" onclick="supplierfun(this.value)">
                                        ...
                                        if (mysqli_num_rows($resultSupplier) > 0) {
                                            while ($rowSupplier = mysqli_fetch_array($resultSupplier)) {
                                                $selected = ($customer == $rowSupplier['customer_id']) ? 'selected' : '';
                                                ?>
                                                <option value='<?php echo $rowSupplier['customer_id'].'_'.$rowSupplier['supply_place']; ?>' <?php echo $selected; ?>>
                                                    <?php echo strtoupper($rowSupplier['customer_name']); ?>
                                                </option>
                                                <?php
                                            }
                                        }
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" class="form-control"  id="productName" name="productName" placeholder="Search Product" readonly style="border-color: #181f5a;color: black;text-transform: uppercase">
...
//                                                    }
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <i data-toggle="modal" data-target="#purchase_list" onclick="editTitle('<?php echo $product_id; ?>','<?php echo $qty; ?>','<?php echo $discount1; ?>','<?php echo $unit; ?>')" class="fa fa-edit edit-icon" style="cursor: pointer;"></i>
                                                        </td>
                                                        <td>
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="number" class="form-control" placeholder="Tax" id="tax" name="tax" style="border-color: #181f5a;color: black">
                                </div>
                                <div class="form-group col-md-4">
                            ...
                            <form id="purchase_form" autocomplete="off">
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="number" class="form-control" id="qtys" name="qtys" readonly style="border-color: #181f5a;color: black;text-transform: uppercase">
                                    </div>
                                    <div class="form-group col-md-12">
                                        <label> Return Quantity * </label>
                                        <input type="number" class="form-control" id="re_qtys" name="re_qtys"  style="border-color: #181f5a;color: black;text-transform: uppercase">
                                    </div>
                                    <div class="form-group col-md-12">
...
<script>
    function navigateToPage() {
        window.location.href = "<?php echo $website; ?>/sale/";
    }
    //due date
...
<script>
    ...
    function editTitle(data,re_quantity,discounts,units) {
        $('#purchase_form')[0].reset();
        var edit_model_title = "Edit Return - "+data;
        $('#titles').html(edit_model_title);
        $('#addbtn').html("Save");
        $('#p_id').val(data);
        $('#qtys').val(re_quantity);
        $('#dis').val(discounts);
        $('#unit').val(units);
    ...
    $("#purchase_form").validate(
        {
            ...
            messages: {
                re_qtys: "*This field is required",
    ...
    $('#addbtn').click(function () {
        if ($("#purchase_form").valid()) {
            const p_id = $('#p_id').val();
            const re_qtys = $('#re_qtys').val();
            const qtys = $('#qtys').val();
            const unit = $('#unit').val();
            const dis = Number($('#dis').val());
            const type = Number($('#type').val());

            $(`#${p_id}_quantity`).text(re_qtys);
            ...
            let subTot;
            if (unit === "MT") {
                subTot = obj.price * (re_qtys * 1000);
            } else {
                subTot = obj.price * re_qtys;
            }
            ...
            $(`#${p_id}_taxValue`).text(Math.round(re_qtys * obj.tax));
        ...
        if($("#staff_form").valid()==true) {
            ...
            for (let i = 0; i < tableRows.length; i++) {
                ...
                const rowData = {
                    ...
                    tax_value: row.cells[10].textContent,
                    subtotal: row.cells[11].textContent,
            ...
            $.ajax({
                ...
                type: "POST",
                url: "return_api.php",
                data: $('#staff_form').serialize() + "&tableData=" + JSON.stringify(rowDataArray)+ "&returnpro=" + returnArr,
                    ...
                    if (res.status == 'success') {
                        Swal.fire(
                            ...
                            .then((value) => {
                                ...
                                window.location.href = "<?php echo $website; ?>/sale_return/";
                            });
