...
//                            }
                            ...
                            $sqlamount="SELECT SUM(pay_made) AS pay_made  FROM purchase_dc WHERE repayment_id='$shipping_id'";
...
<!--                                    <div class="dropdown">-->
<!--                                        <a href="--><?php //echo $website?><!--/Ledgers/purchase_dc_payment/show_file.php?purchase_payment_id=--><?php //echo $row['purchase_payment_id']?><!--"-->
