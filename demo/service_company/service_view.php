...
if($service_id != '' && $service_type == 'company_profile') {
    $sql = "SELECT * FROM service_profile WHERE service_profile_id='$service_id'";
...
$sqlcl = "SELECT COUNT(id) AS clCount FROM service_contact WHERE service_profile_id='$service_id'";
$resultcl = mysqli_query($conn, $sqlcl);
$rowcl = mysqli_fetch_assoc($resultcl);
$clCount = $rowcl['clCount'];

$sqlgl = "SELECT COUNT(id) AS glCount FROM service_requirement WHERE service_profile_id='$service_id'";
$resultgl = mysqli_query($conn, $sqlgl);
$rowgl = mysqli_fetch_assoc($resultgl);
$glCount = $rowgl['glCount'];

$sqlPl = "SELECT COUNT(id) AS plCount FROM service_details WHERE service_profile_id='$service_id'";
$resultPl = mysqli_query($conn, $sqlPl);
$rowPl = mysqli_fetch_assoc($resultPl);
$plCount = $rowPl['plCount'];

$sqlhl = "SELECT COUNT(id) AS hlCount FROM service_laddle WHERE service_profile_id='$service_id'";
                ...
                <div class="card-body">
                    ...
                    <div class="basic-form" style="color: black;">
                        <form id="q1_form">
                            ...
                            <input type="hidden" class="form-control"  id="service_profile_id" name="service_profile_id" value="<?php echo $service_id?>">
                            <input type="hidden" class="form-control"  id="service_profile_type" name="service_profile_type" value="<?php echo $service_type?>">
                            <?php
                            if($service_id != '' && $service_type == 'company_profile') {
                            ?>
                            <div class="form-row">
                            ...
                            <?php }?>
                            <?php
                            if($service_id != '' && $service_type == 'contact_details') {
                            ?>
                            <!--  contact details-->
                                ...
                                <div class="row" style="margin-top: 20px;padding: 15px;">
                                    <div class="col-md-12 col-sm-12">
                                        <div class="" id="cardLoan_div">
                                            ...
                                            <?php
                                            if($clCount > 0) {
                                                $sqlCardLoan = "SELECT * FROM service_contact WHERE service_profile_id='$service_id'";
                            ...
                            <?php
                            if($service_id != '' && $service_type == 'requirement_details') {
                            ?>
                            <!--  Material Required-->
                            <section class="review-section information">
                                <div class="review-header text-center">
                                ...
                                <div class="row" style="margin-top: 20px;padding: 15px;">
                                    <div class="col-md-12 col-sm-12">
                                        <div class="" id="goldLoan_div">
                                            ...
                                            <?php
                                            if($glCount > 0) {
                                                $sqlGoldLoan = "SELECT * FROM service_requirement WHERE service_profile_id='$service_id'";
                            ...
                            <?php
                            if($service_id != '' && $service_type == 'furnace_details') {
                            ?>
                            <section class="review-section information">
                                <div class="review-header text-center">
                                ...
                                <div class="row" style="margin-top: 20px;padding: 15px;">
                                    <div class="col-md-12 col-sm-12">
                                        <div class="" id="personalLoan_div">
                                            ...
                                            <?php
                                            if($plCount > 0) {
                                                $sqlPersonalLoan = "SELECT * FROM service_details WHERE service_profile_id='$service_id'";
                            ...
                            <?php
                            if($service_id != '' && $service_type == 'laddle_details') {
                            ?>
                            <section class="review-section information">
                                <div class="review-header text-center">
                                ...
                                <div class="row" style="margin-top: 20px;padding: 15px;">
                                    <div class="col-md-12 col-sm-12">
                                        <div class="" id="homeLoan_div">
                                            ...
                                            <?php
                                            if($hlCount > 0) {
                                                $sqlHomeLoan = "SELECT * FROM service_laddle WHERE service_profile_id='$service_id'";
