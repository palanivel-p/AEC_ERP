                        ...
                        <form id="q1_form">
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" class="form-control" placeholder="Customer Name" id="customer_name" name="customer_name" style="border-color: #181f5a;color: black;text-transform: uppercase">
                                ...
                                <div class="form-group col-md-4">
                                    <label>Charges </label>
                                    <input type="number" class="form-control" placeholder="Charges" id="charges" name="charges"  style="border-color: #181f5a;color: black">
                                </div>
                            </div>
                            <!--  contact details-->
