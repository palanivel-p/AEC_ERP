            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div style="display: flex;justify-content: flex-end;">
                        ...
                        <button type="button" class="btn btn-primary mb-2" onclick="window.location.href='<?php echo $website; ?>/service_company/profile.php'">ADD</button>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-responsive-md" style="text-align: center;">
                            ...
                            if($product_id == "") {
                                $sql = "SELECT * FROM service_profile WHERE added_date  BETWEEN '$from_date' AND '$to_date' $addedBy ORDER BY id  LIMIT $start,10";
                            }
                            {
                                $sql = "SELECT * FROM service_profile WHERE added_date  BETWEEN '$from_date' AND '$to_date'  $addedBy ORDER BY id  LIMIT $start,10";
                            }
