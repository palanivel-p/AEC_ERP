                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table table-responsive-md" style="text-align: center;">
                            ...
                            <tr>
                                ...
                                <th><strong>Product Return Id</strong></th>
...
//                            }
                            $sql = "SELECT * FROM purchase_return_details WHERE return_id = '$return_id' ORDER BY id DESC LIMIT $start,10";
                            ...
                            <tr>
                                ...
                                <td> <?php echo $purchase_return_details_id?> </td>
...
//                                    $sql = "SELECT COUNT(id) as count FROM purchase_return_details";
                                    $sql = "SELECT COUNT(id) as count FROM purchase_return_details WHERE return_id = '$return_id'";
