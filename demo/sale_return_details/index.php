                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table table-responsive-md" style="text-align: center;">
                            ...
                            <tr>
                                ...
                                <th><strong>Sale Return Id</strong></th>
...
//                                $sql = "SELECT * FROM purchase_return_details WHERE return_date  BETWEEN '$from_date' AND '$to_date' ORDER BY id DESC LIMIT $start, 10";
//
//                            }
//                            else {
//                                $sql = "SELECT * FROM purchase_return_details WHERE id > 0 WHERE return_date  BETWEEN '$from_date' AND '$to_date' $pur_idSql ORDER BY id DESC LIMIT $start,10";
//                            }
                            $sql = "SELECT * FROM sale_return_details WHERE return_id = '$return_id' ORDER BY id DESC LIMIT $start,10";
                            ...
                            $returns_id =  $row['return_id'];
                            $sale_return_details_id =  $row['sale_return_details_id'];
                            $sale_id =  $row['sale_id'];
                            $product_name=  $row['product_name'];
                            $qty=  $row['qty'];

                            $sqlCustomer="SELECT *  FROM sale_return WHERE return_id='$returns_id'";
                            $resCustomer = mysqli_query($conn, $sqlCustomer);
                            $rowCustomer = mysqli_fetch_assoc($resCustomer);
                            $customer_id =  $rowCustomer['customer'];
                            ...
                            <tr>
                                ...
                                <td> <?php echo $returns_id?> </td>
                                <td> <?php echo $sale_return_details_id?> </td>
...
//                                    $sql = "SELECT COUNT(id) as count FROM purchase_return_details";
                                    $sql = "SELECT COUNT(id) as count FROM sale_return_details WHERE return_id = '$return_id'";
