                    ...
                    <div class="table-responsive">
                        <table class="table table-responsive-md" style="text-align: center;">
                            ...
                            //                                $sql = "SELECT * FROM market WHERE visit_date  BETWEEN '$from_date' AND '$to_date'$addedBy ORDER BY id  LIMIT $start,10";
                                                                $sql = "SELECT * FROM market WHERE next_follow > '$currentDate'$product_idSql ORDER BY next_follow DESC LIMIT $start,10";
                                                        }
                                                        else{
//                                                            $sql = "SELECT * FROM market WHERE visit_date  BETWEEN '$from_date' AND '$to_date' $product_idSql$addedBy ORDER BY id  LIMIT $start,10";
                                                                   $sql = "SELECT * FROM market WHERE next_follow  BETWEEN '$from_date' AND '$to_date'$product_idSql ORDER BY next_follow  LIMIT $start,10";
                                                        }
                            ...
                            //                               $sqlExpenseType = "SELECT * FROM `expense_category` WHERE `category_id`='$market_id'";
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item" data-toggle="modal" data-target="#career_list" style="cursor: pointer" onclick="editTitle('<?php echo $row['market_id'];?>')">Edit</a>
...
<!--                                    <div class="form-group col-md-6" id="c_name">-->
<!--                                        <label>Customer Name*</label>-->
<!--                                        <select data-search="true" class="form-control js-example-disabled-results tail-select w-full" id="customer_name" name="customer_name" style="border-color: #181f5a;color: black" onchange="supplierfun(this.value)">-->
...
<!--                                    </div>-->
                                    ...
                                    <div class="form-group col-md-6" id="s_qty">
                                        ...
                                        <input type="text" class="form-control" placeholder="Assigned To" id="assigned" name="assigned" style="border-color: #181f5a;color: black">
                                    </div>
