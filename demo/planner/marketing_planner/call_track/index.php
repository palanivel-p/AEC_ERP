...
//                                        echo "<th style='width: 100px; white-space: nowrap;'><strong>$formatted_date ($customer_count)</strong></th>";
                            ...
                            if($customer_name == "" && $f_date !="" && $t_date !="") {
                                ...
                                $sql = "SELECT * FROM call_track where call_date BETWEEN '$f_date' AND '$t_date' GROUP BY customer_id  ORDER BY id DESC LIMIT $start,10";
                            }
...
//                                    }
                                    ...
                                    while ($current_date <= $t_date) {
                                        ...
                                        if (isset($counts[$formatted_date])) {
                                            echo "<td>";
                                            $sqlIntend = "SELECT * FROM `call_track` WHERE `customer_name`='$customer_name' AND call_date='$formatted_date'";
...
//                                        $sql = "SELECT COUNT(id) as count FROM call_track GROUP BY customer_id";
                                    if($customer_name == "" && $f_date !="" && $t_date !="") {
                                        ...
                                        $sql = "SELECT COUNT(id) as count FROM call_track where call_date BETWEEN '$f_date' AND '$t_date'";
                                    }
                                    else if ($customer_name != "" && $f_date !="" && $t_date !=""){
