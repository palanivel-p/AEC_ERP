            ...
            <div class="card">
                <div class="card-body">
                    <div class="card-header">
                        <h4 class="card-title">View / Cheque</h4>
                        <div style="display: flex;justify-content: flex-end;">
                            <a href="<?php echo $website?>/cheque/"><button class="btn btn-danger" type="button">Close</button></a>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <?php
                                  ...
                                  $sql = "SELECT * FROM cheque WHERE cheque_id='$cheque_id'";
                                ...
                                <table class="table table-bordered" style="text-align: center;">
                                    ...
                                    <!--                                    </tr>-->
                                    <tr>
                                        <th class="table_head"><strong>Cheque Id</strong></th>
                                        <td class="table_data"><?php echo $row['cheque_id']?></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <th class="table_head"><strong>Bank Name</strong></th>
                                        <td class="table_data"><?php echo $row['bank_name']?></td>
                                    </tr>
