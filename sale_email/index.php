...
<div id="printPdf">
    <div class="table-container">
        ...
        <tbody>
            ...
            <tr>
             <th style="text-align: left">Shipping Amount </th>
...
if (mysqli_num_rows($result)>0) {
    ...
    while($row = mysqli_fetch_assoc($result)) {
        ...
        $data .= '
            ...
            <td><span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span>'. $unit_cost.'</td>
            <td>'. $discount.'</td>
            <td><span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span>'. $discount_value.'</td>
            <td>'. $tax.'</td>
            <td><span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span>'. $tax_value.'</td>
...
$data .= '
         <table>
            ...
            <td colspan="2" style="text-align: right"><span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span>'.$totalAmount.'</td>
            </tr>
            <tr>
            <th colspan="8" rowspan="2">'.$numberIntoWords.'</th>
            <td colspan="1">Discount value</td>
            <td colspan="2" style="text-align: right">(-)<span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span>'.$totalDiscountValue.'</td>
            </tr>
             <tr>
           
            <td colspan="1">Tax ('.$tax.')</td>
            <td colspan="2" style="text-align: right">(+)<span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span>'.$totalTaxValue.'</td>
            </tr>
            <tr>
            ...
            <td colspan="2" style="text-align: right"><span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span>'. $grand_total.'</td>
            </tr>
            <tr>
    
            <td colspan="1">Payment Made</td>
            <td colspan="2" style="text-align: right"><span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span>'.$totalAmountSS.'</td>
            </tr>
            
             <tr>
            <td colspan="1">Balance Due</td>
            <td colspan="2" style="text-align: right"><span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span>'.$balance_amount.'</td>
            </tr>
        ...
        <table>
            <tbody>   
              <tr>
                <td><p style="margin-top:60px;text-align: center">Prepared by</p></td>
                <td><p style="margin-top:60px;text-align: center">Checked by</p></td>
...
$obj->render();
$output = $obj->output();
file_put_contents($sale_id.'.pdf', $output);
...
//readfile($_SERVER["DOCUMENT_ROOT"].'/purchase_invoice/'.$sale_id.'.pdf');
...
$emailTo = "dinesh000240@gmail.com";
$emailToName = "AEC";
...
//    $mail->AddAttachment( $file_to_attach , 'PR002.pdf' );
    $mail->AddAttachment( $sale_id.'.pdf' );
...
//    }
    ...
    $json_array['msg'] = "Email Sent Successfully!!!";
