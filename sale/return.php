    ...
    <div class="content-body">
        <div class="page-titles" style="margin-left: 21px;">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="javascript:void(0)">Return sale</a></li>
            </ol>
...
<script>
    ...
    function editTitle(data) {
        ...
        let RETURN_QUANTITY = document.getElementById(`${data}_quantity`).innerHTML;
        document.getElementById('re_qtys').value = Number(RETURN_QUANTITY);
    ...
    $('#addbtn').click(function () {
        if ($("#purchase_form").valid()) {
            const p_id = $('#p_id').val();
            const qtys = $('#qtys').val();
            const re_qtys = Number($('#re_qtys').val());
            const unit = $('#unit').val();
            ...
            if (re_qtys > qtys) {
                Swal.fire({
                    ...
                    text: 'The return quantity exceeds the actual quantity.',
                });
                return;
            }
            ...
            if (unit === "MT") {
                let stkxqty = re_qtys * 1000;
                if (stk < stkxqty) {
                    showAlert = true;
                }
            } else if (unit === "bgs") {
                let stkxqty = re_qtys * 25;
                if (stk < stkxqty) {
                    showAlert = true;
                }
            } else if (unit === "mm") {
                let stkxqty = re_qtys * 12;
                if (stk < stkxqty) {
                    showAlert = true;
                }
            } else {
