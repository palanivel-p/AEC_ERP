...
//                                $sql = "SELECT * FROM purchase  ORDER BY id  LIMIT $start,10";
                                ...
                                $sql = "SELECT * FROM sale WHERE id > 0 WHERE sale_date  BETWEEN '$from_date' AND '$to_date' $pur_idSql ORDER BY id DESC LIMIT $start,10";
                            }
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            <a class="dropdown-item" data-toggle="modal" data-target="#repayment_list" style="cursor: pointer" onclick="repayment('<?php echo $sale_id?>')">Payment</a>
