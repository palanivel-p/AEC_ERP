...
if($py_sts != ""){
    $py_stsSql= " AND py_status = '".$py_sts."'";
}
else{
    $py_stsSql ="";
}
...
<head>
    ...
    <title>All Sale profile</title>

    <link rel="icon" type="image/png" sizes="16x16" href="../includes/AEC_fav.png">
...
//                                $sql = "SELECT * FROM purchase  ORDER BY id  LIMIT $start,10";
                                $sql = "SELECT * FROM sale WHERE sale_date  BETWEEN '$from_date' AND '$to_date' ORDER BY id DESC LIMIT $start, 10";
                            }
                            else {
                                   $sql = "SELECT * FROM sale  WHERE sale_date  BETWEEN '$from_date' AND '$to_date' $pur_idSql$py_stsSql ORDER BY id DESC LIMIT $start,10";
                            }
                            ...
                            $balanceAmount_formatted = number_format($balance_amount, 2, '.', '');

                            if($totalAmount == ''){
                                $totalAmount = 'NA';
                                $totalAmount_formatted = $totalAmount;
                            }
                            else{
                                $totalAmount = $totalAmount;
                                $totalAmount_formatted = number_format($totalAmount, 2, '.', '');
                            ...
                            $customer =  $rowSupplier['customer_name'];
                            ...
                            if($grand_total == 0){
                                $balanceAmount_formatted = 0;
                                $totalAmount_formatted = 0;
                                $statCont ='Return';
                                $statColor = 'danger';
                            ...
                            <tr>
                                ...
                                <td> <?php echo $totalAmount_formatted?> </td>
                                <td> <?php echo $balanceAmount_formatted?> </td>
                                <td> <?php echo $py_status?> </td>
                                <td> <span class="badge badge-pill badge-<?php echo $statColor?>"><?php echo $statCont?></span></td>
                                <td> <a href="invoice.php?sale_id=<?php echo $sale_id ?>"><span class="badge badge-pill badge-primary">Download</span></a></td>
                                <td class="text-center">
                                    <div class="dropdown">
                                        <a href="<?php echo $website?>/sale/show_file.php?sale_id=<?php echo $row['sale_id']?>"
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            ?>
                                            <a class="dropdown-item" href="<?php echo $website; ?>/sale/edit.php?sale_id=<?php echo $sale_id?>" style="cursor: pointer" >Edit</a>
                                                <?php
                                            }
                                            ?>
                                            <?php
                                            if($_COOKIE['role'] == 'Super Admin' || $_COOKIE['role'] == 'Admin'|| $_COOKIE['role'] == 'Sales'|| $_COOKIE['role'] == 'Stores') {
                                            ?>
                                            <a class="dropdown-item" href="<?php echo $website; ?>/sale/return.php?sale_id=<?php echo $sale_id?>" style="cursor: pointer" >Return</a>
                                            <!--                                            <a class="dropdown-item" data-toggle="modal" data-target="#career_list" style="cursor: pointer" onclick="status_fun(<?php //echo $sale_id;?>>Status</a>-->
                                            <a class="dropdown-item" data-toggle="modal" data-target="#purchase_list" style="cursor: pointer" onclick="shipping('<?php echo $row['sale_id'];?>')">Shipment</a>
                                                <?php
                                            }
                                            ?>
                                            <?php
                                            if($_COOKIE['role'] == 'Super Admin' || $_COOKIE['role'] == 'Admin'|| $_COOKIE['role'] == 'Sales') {
                                            ?>
                                            <a class="dropdown-item" data-toggle="modal" data-target="#repayment_list" style="cursor: pointer" onclick="repayment('<?php echo $row['sale_id']?>','<?php echo $row['grand_total']?>','<?php echo $totalAmount?>','<?php echo $balance_amount?>')">Create Payment</a>
                                            <a class="dropdown-item" data-toggle="modal" data-target="#email_list" style="cursor: pointer" onclick="email('<?php echo $sale_id?>')">Send Email</a>
<!--                                            <a class="dropdown-item" href="<?php echo $website; ?>/sale_email/index.php?sale_id=--><?php //echo $sale_id?><!--" style="cursor: pointer" >email</a>-->
                                                <?php
                                            }
                                            ?>
                                            <?php
                                            if($_COOKIE['role'] == 'Super Admin') {
                                            ?>
                                            <a class="dropdown-item" style="cursor: pointer" onclick="delete_model('<?php echo $sale_id;?>')">Delete</a>
                                                <?php
                                            }
                                            ?>
                                        </div>
                        ...
                        <div class="col-12 pl-3" style="display: flex;justify-content: center;">
                            <nav>
                                <ul class="pagination pagination-gutter pagination-primary pagination-sm no-bg">
                                    ...
                                    if($pur_id == "" && $py_sts == "") {
//                                $sql = "SELECT * FROM purchase  ORDER BY id  LIMIT $start,10";
                                        $sql = "SELECT COUNT(id) as count FROM sale WHERE sale_date  BETWEEN '$from_date' AND '$to_date' ORDER BY id DESC";
                                    }
                                    else {
                                        $sql = "SELECT COUNT(id) as count FROM sale  WHERE sale_date  BETWEEN '$from_date' AND '$to_date' $pur_idSql$py_stsSql ORDER BY id DESC";
                                    }
                            ...
                            <form id="purchase_form" autocomplete="off">
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="hidden" class="form-control" placeholder="sale Id" id="s_id" name="s_id" value="">                                  <input type="hidden" class="form-control"  id="old_pa_id" name="old_pa_id">
                            ...
                            <form id="email_form" autocomplete="off">
                                <div class="form-row">
                                    <div class="form-group col-md-12" id="payment_date">
                                        <label>Sale Id</label>
                                        <input type="text" class="form-control" id="sa_id" name="sa_id" style="border-color: #181f5a;color: black">
                                    </div>
                                    <div class="form-group col-md-12" id="payment_date">
        ...
        <div class="modal fade" id="repayment_list"  data-keyboard="false" data-backdrop="static">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="title">Payment</h5>
                        <button type="button" class="close" data-dismiss="modal"><span>&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
...
<!--                                        <input type="hidden" class="form-control"  id="sal_id" name="sal_id">-->
<!--                                    </div>-->
<!--                                    <div class="form-group col-md-6" id="pay_mades">-->
<!--                                        <label>Sale ID</label>-->
<!--                                        <input type="text" class="form-control" placeholder="Sale Id" id="saleid" name="saleid" readonly style="border-color: #181f5a;color: black">-->
<!--                                    </div>-->
...
<!--                            </form>-->
                            <form id="repayment_form" autocomplete="off">
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6" id="tdss">
                                        <label>TDS </label>
                                        <input type="number" class="form-control" placeholder="TDS" id="tds" name="tds" style="border-color: #181f5a;color: black">
                                    </div>
                                    <div class="form-group col-md-6" id="repayment_modes">
                                        <label>Payment Mode </label>
                                        <select  class="form-control" id="repayment_mode" name="repayment_mode" style="border-color: #181f5a;color: black;text-transform: uppercase;">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="basic-form" style="color: black;">
                            <form id="status_form" autocomplete="off">
                                ...
                                <?php
                                $sale_sts = $_GET['sale_sts'];

                                $sql = "SELECT * FROM sale_details WHERE sale_id = '$sale_sts'";
                                $result = mysqli_query($conn, $sql);
                                if (mysqli_num_rows($result)>0) {
                                    $sNo = 1;
                                    while($row = mysqli_fetch_assoc($result)) {
                                        ...
                                        $sqlSubCategory = "SELECT * FROM `sale` WHERE `sale_id`='$sale_sts'";
                        ...
                        <form id="filter_form" autocomplete="off">
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-12">
                                    <label>Sale Id </label>
                                    <input type="text"  class="form-control" placeholder="Sale Id" id="pur_id" name="pur_id" style="border-color: #181f5a;color: black">
                                </div>
                                <div class="form-group col-md-12">
                                ...
                                <div class="form-group col-md-12">
                                    <label>Status</label>
                                    <select data-search="true" class="form-control tail-select w-full" id="py_sts" name="py_sts" style="border-color: #181f5a;color: black">
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const tdss = document.getElementById('tdss');
    ...
    function status_fun(data) {
        window.location.href="../sale/all_sale.php?sale_sts="+data;
    }
    var sts = '<?php echo  $_GET['sale_sts']?>';
    if(sts != ''){
                ...
                success: function (res) {
                    if (res.status == 'success') {
                        Swal.fire(
                            ...
                            .then((value) => {
                                window.location.href="../sale/all_sale.php";
                            });
    ...
    $('#email_btn').click(function () {
        ...
        if($("#email_form").valid()==true) {
            ...
            $.ajax({
                ...
                type: "POST",
                url: "<?php echo $website; ?>/sale_email/index.php",
    ...
    //     }
    // });
    function repayment(saleid,gtotal,pamount,damount) {
        $("#title").html("Add Payment "+ saleid);
    ...
    $(document).on("click", ".excel_download", function () {
        window.location.href = "excel_download.php?&pur_id=<?php echo $pur_id?>&f_date=<?php echo $from_date?>&t_date=<?php echo $to_date?>&py_sts=<?php echo $py_sts?>";
    });
    $(document).on("click", ".pdf_download", function () {
        window.location.href = "pdf_download.php?&pur_id=<?php echo $pur_id?>&f_date=<?php echo $from_date?>&t_date=<?php echo $to_date?>&py_sts=<?php echo $py_sts?>";
    });

    function pdf(sale_id) {
        window.location.href= '<?php echo $website; ?>/sale/invoice.php?sale_id='+sale_id;
    }
</script>
