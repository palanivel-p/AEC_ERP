                    ...
                    <div class="basic-form" style="color: black;">
                        <form id="staff_form" autocomplete="off">
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-4">
                                    <label> PO No *</label>
                                    <input type="text" class="form-control" placeholder="PO No" id="po_no" name="po_no" style="border-color: #181f5a;color: black;text-transform: uppercase">
                                </div>
                                <div class="form-group col-md-4">
                                    <label> PO Date *</label>
                                    <input type="date" class="form-control" id="po_date" name="po_date" style="border-color: #181f5a;color: black;text-transform: uppercase">
                                </div>
                                <div class="form-group col-md-4">
                                    <label>Customer *</label>
                                    <select data-search="true" class="form-control tail-select w-full" id="customer" name="customer" style="border-color: #181f5a;color: black" onchange="supplierfun(this.value)">
                                        ...
                                        if (mysqli_num_rows($resultSupplier) > 0) {
                                            while ($rowSupplier = mysqli_fetch_array($resultSupplier)) {
                                                ?>
                                                <option
                                                        value='<?php echo $rowSupplier['customer_id'].'_'.$rowSupplier['supply_place']; ?>'><?php echo strtoupper($rowSupplier['customer_name']); ?></option>
                                                <?php
                                            }
                                        }
                                        ?>
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" class="form-control" placeholder="E-way Bill " id="e_way" name="e_way" style="border-color: #181f5a;color: black">
                                </div>
                                <div class="form-group col-md-4">
                                    <label> Status </label>
                            ...
                            <form id="purchase_form" autocomplete="off">
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="hidden" class="form-control" placeholder="Product Id" id="s_id" name="s_id" style="border-color: #181f5a;color: black;text-transform: uppercase">
                                        <input type="hidden" class="form-control"  id="api" name="api">
                                        <input type="hidden" class="form-control"  id="old_pa_id" name="old_pa_id">
...
<script>
    ...
    $('#addbtn').click(function () {
        if ($("#purchase_form").valid()) {
            ...
            $(`#${s_id}_descrip`).text(desc);
            $(`#${s_id}_quantity`).text(qtys);
            $(`#${s_id}_bunit`).text(unit);
            $('#purchase_form')[0].reset();
            ...
            const subTotElement = document.getElementById(`${s_id}_totAmout`);
            const disPercentage = document.getElementById(`${s_id}_disPercentage`);


            let obj = productDetailArr.find(o => o.product_id === s_id);
            ...
            $(`#${s_id}_taxValue`).text(Math.round(qtys * obj.tax));
        ...
        if($("#staff_form").valid()==true) {
            ...
            for (let i = 0; i < tableRows.length; i++) {
                ...
                const rowData = {
                    ...
                    productDesc: row.cells[12].textContent,
