...
$objPHPExcel->getActiveSheet()->setCellValue('B2', 'Role');
$objPHPExcel->getActiveSheet()->setCellValue('C2', 'User Name');
$objPHPExcel->getActiveSheet()->setCellValue('D2', 'Date');
$objPHPExcel->getActiveSheet()->setCellValue('E2', 'User Activity');
...
$objWriter->save($_SERVER["DOCUMENT_ROOT"].'/user_report.csv');
sleep(1);

header('Content-type: application/octet-stream');
header("Content-Disposition: attachment; filename=user_report.csv");
readfile($_SERVER["DOCUMENT_ROOT"].'/user_report.csv');

@unlink($_SERVER["DOCUMENT_ROOT"].'/user_report.csv');
