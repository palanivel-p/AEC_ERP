                        ...
                        <div class="col-12 pl-3" style="display: flex;justify-content: center;">
                            <nav>
                                <ul class="pagination pagination-gutter pagination-primary pagination-sm no-bg">
                                    ...
                                    {
                                        ?>
                                        <li class="page-item page-indicator"><a class="page-link" href="?page_no=<?php echo $prevPage?>&user_role=<?php echo $role ?>&u_name=<?php echo $user_name?>"><i class="fa-solid fa-less-than"></i></a></li>
                                        <?php
                                    }
                                    if($user_name == "" && $role == "") {
...
//                                    }
                                    ...
                                    if (mysqli_num_rows($result)) {
                                        ...
                                        for ($i = 1; $i <= $pageFooter; $i++) {
                                            ...
                                            if($i<=($pageSql+10) && $i>$pageSql || $pageFooter<=10) {
                                                ...
                                                <li class="page-item <?php echo $active ?>"><a class="page-link"
                                                                                               href="?page_no=<?php echo $i ?>&user_role=<?php echo $role ?>&u_name=<?php echo $user_name?>"><?php echo $i ?></a>
                                                </li>
                                                <?php
                                            }
                                        }
                                        ...
                                        {
                                            ?>
                                            <li class="page-item page-indicator"><a class="page-link" href="?page_no=<?php echo $nextPage ?>&user_role=<?php echo $role ?>&u_name=<?php echo $user_name?>"><i class="fa-solid fa-greater-than"></i></a></li>
                                            <?php
                                        }
                                    }
                                    ?>
    ...
    <script>
        ...
        //});
        $(document).on("click", ".excel_download", function () {
            window.location.href = "excel_download.php?&user_role=<?php echo $role ?>&u_name=<?php echo $user_name?>";
        });
