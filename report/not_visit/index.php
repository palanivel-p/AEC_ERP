        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Not Visit-Report </h4>
                    ...
                    <div class="table-responsive">
                        <table class="table table-responsive-md" style="text-align: center;">
                            ...
                            if (mysqli_num_rows($result) > 0) {
                                $sNo = 1; // Assuming $start is not defined, we start at 1
...
//                                    }
                                    //                                    if($user_name == "" && $role == "") {
                                    $sql = "SELECT COUNT(mp.customer_name) as count
        FROM market_profile mp
        JOIN marketing m ON mp.customer_name = m.customer_name 
                         AND mp.assigned_to = m.added_by
        WHERE NOT (mp.added_date BETWEEN m.visit_date - INTERVAL '30' DAY AND m.visit_date)";
