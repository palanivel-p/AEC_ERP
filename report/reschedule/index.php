        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Reschedule-Report List</h4>
                    ...
                    <div class="table-responsive">
                        <table class="table table-responsive-md" style="text-align: center;">
                            ...
                            <tr>
                                ...
                                <th><strong>Reschedule Date</strong></th>
...
//                            if($user_name == "" && $role == "") {
                                $sql = "SELECT * FROM marketing WHERE `type` = 'reschedule' ORDER BY id DESC LIMIT $start,10";
//                            }
//                            else {
//                                $sql = "SELECT * FROM marketing WHERE `type` = 'reschedule' $user_nameSql$roleSql ORDER BY id  LIMIT $start,10";
//                            }
...
//                                    if($user_name == "" && $role == "") {
                                        $sql = "SELECT COUNT(id) as count FROM marketing WHERE `type` = 'reschedule'";
//                                    }
//                                    else {
