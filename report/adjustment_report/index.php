...
<div id="main-wrapper">
                            ...
                            <nav>
                                <ul class="pagination pagination-gutter pagination-primary pagination-sm no-bg">
                                    ...
                                    if($adjustment_id == "" && $p_name == "") {
                                        ...
                                        $sql = "SELECT COUNT(id) as count FROM adjustment_details WHERE id > 0 $adj_idSql$pNameSql";
                                    }
                                    $result = mysqli_query($conn, $sql);
                                    ...
                                    if (mysqli_num_rows($result)) {
                                        ...
                                        for ($i = 1; $i <= $pageFooter; $i++) {
                                            ...
                                            if($i<=($pageSql+10) && $i>$pageSql || $pageFooter<=10) {
                                                ...
                                                <li class="page-item <?php echo $active ?>"><a class="page-link"
                                                                                               href="?page_no=<?php echo $i ?>&p_name=<?php echo $p_name ?>&adjustment_id=<?php echo $adjustment_id?>"><?php echo $i ?></a>
                                                </li>
                                                <?php
                                            }
                                        }
                                        ...
                                        {
                                            ?>
                                            <li class="page-item page-indicator"><a class="page-link" href="?page_no=<?php echo $nextPage ?>&p_name=<?php echo $p_name ?>&adjustment_id=<?php echo $adjustment_id?>"><i class="fa-solid fa-greater-than"></i></a></li>
                                            <?php
                                        }
                                    }
                                    ?>
                            ...
                            <form id="filter_form" autocomplete="off">
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="text"  class="form-control" placeholder="Adjustment Id" id="adjustment_id" name="adjustment_id" style="border-color: #181f5a;color: black">
                                    </div>
                                    <button type="submit" class="btn btn-primary mb-2">Search</button>
                                </div>
                            </form>
    ...
    <script>
        ...
        //});
        $(document).on("click", ".excel_download", function () {
            window.location.href = "excel_download.php?&p_name=<?php echo $p_name?>&adjustment_id=<?php echo $adjustment_id?>";
        });
