            ...
            <div class="card">
                <div class="card-body">
                    <div class="card-header">
                        <h4 class="card-title">View / Purchase Return</h4>
                        <div style="display: flex;justify-content: flex-end;">
                            <a href="<?php echo $website?>/purchase_return/"><button class="btn btn-danger" type="button">Close</button></a>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <?php
                                  ...
                                  $sql = "SELECT * FROM purchase_return WHERE return_id='$return_id'";
                                ...
                                $r_date =  $rowPurchase['return_date'];
                                $return_date = date('d-m-Y', strtotime($r_date));
                                ...
                                $Currency =  $rowCurrency['currency_name'];
                                ...
                                $material_date = date('d-m-Y', strtotime($material));
                                ...
                                $date = $rowPurchase['adjustment_date'];
                                ...
                                <table class="table table-bordered dom" style="text-align: center;">
                                    ...
                                    <tr>
                                        <th class="table_head"><strong>Purchase Date</strong></th>
                                        <td class="table_data"><?php echo $purchase_date?></td>
                                    </tr>
                                    <tr>
                                        <th class="table_head"><strong>Return Date</strong></th>
                                        <td class="table_data"><?php echo $return_date?></td>
                                    </tr>
                                    <tr>
                                        <th class="table_head"><strong>Supplier</strong></th>
                                        <td class="table_data"><?php echo $Supplier?></td>
                                    </tr>

                                    <tr>
                                        <th class="table_head"><strong>Currency</strong></th>
                                        <td class="table_data"><?php echo $Currency?></td>
                                    </tr>
                                    <tr>
                                        <th class="table_head"><strong>Payment terms</strong></th>
                                        <td class="table_data"><?php echo$payment_terms?></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <th class="table_head"><strong>Received Date</strong></th>
                                        <td class="table_data"><?php echo $m_date?></td>
                                    </tr>
                                    <tr>
...
<!--                                        <th class="table_head"><strong>Product code</strong></th>-->
                                    ...
                                    <tbody>
                                    <?php
                                    $sql = "SELECT * FROM purchase_return_details WHERE purchase_id ='$p_id'";
                                    $result = mysqli_query($conn, $sql);
