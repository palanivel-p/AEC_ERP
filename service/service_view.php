...
<div id="main-wrapper">
    <?php
    $header = "Service";
    $header_name =$header . " - " . $service_type . " View";
                            ...
                            <form id="q1_form">
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <select name="material_type" id="material_type" class="form-control" value="<?php echo $material_type?>" disabled style="border-color: #181f5a;color: black">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="number" class="form-control" placeholder="Furnace Top-Dia" id="furnace_top" name="furnace_top" value="<?php echo $furnace_top?>" readonly style="border-color: #181f5a;color: black">
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label>Furnace Bottom-Dia </label>
                                        <input type="number" class="form-control" placeholder="Furnace Bottom-Dia" id="furnace_bottom" name="furnace_bottom" value="<?php echo $furnace_bottom?>" readonly style="border-color: #181f5a;color: black">
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label>Furnace Height</label>
                                        <input type="number" class="form-control" placeholder="Furnace Height" id="furnace_height" name="furnace_height" value="<?php echo $furnace_height?>" readonly style="border-color: #181f5a;color: black">
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label>Former Top-Dia </label>
                                        <input type="number" class="form-control" placeholder="Former Top-Dia" id="former_top" name="former_top" value="<?php echo $former_top?>" readonly style="border-color: #181f5a;color: black">
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label>Former Bottom-Dia </label>
                                        <input type="number" class="form-control" placeholder="Former Bottom-Dia" id="former_bottom" name="former_bottom" value="<?php echo $former_bottom?>" readonly style="border-color: #181f5a;color: black">
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label>Former Height </label>
                                        <input type="number" class="form-control" placeholder="Former Height" id="former_height" name="former_height" value="<?php echo $former_height?>" readonly style="border-color: #181f5a;color: black">
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label>Former Topper-Height </label>
                                        <input type="number" class="form-control" placeholder="Former Topper-Height" id="former_tapper" name="former_tapper" value="<?php echo $former_tapper?>" readonly style="border-color: #181f5a;color: black">
                                    </div>
                                                        ...
                                                        while($rowHomeLoan = mysqli_fetch_assoc($resultHomeLoan)) {
                                                            ...
                                                            <div class="row personalLoanInputs" id="<?php echo 'personalLoan_divRow_'.$hlCount_id?>"><br>
                                                                ...
                                                                <div class="col-md-4">
                                                                    <div class="input-block mb-3">
                                                                        <label>PRESSURE</label>
                                                                        <input type="text" class="form-control plAdd" id="<?php echo 'pressure_'.$hlCount_id?>" name="<?php echo 'pressure_'.$hlCount_id?>" value="<?php echo $pressure?>" readonly style="border-color: black;color: black">
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-4">
                                                                    <div class="input-block mb-3">
                                                                        <label>QTY</label>
                                                                        <input type="text" class="form-control plAdd" id="<?php echo 'qty_'.$hlCount_id?>" name="<?php echo 'qty_'.$hlCount_id?>" value="<?php echo $qty?>" readonly style="border-color: black;color: black">
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-4">
                                                                    <div class="input-block mb-3">
                                                                        <label>FORK START TIME</label>
                                                                        <input type="time" class="form-control plAdd" id="<?php echo 'fork_start_time_'.$hlCount_id?>" name="<?php echo 'fork_start_time_'.$hlCount_id?>" value="<?php echo $fork_start_time?>" readonly style="border-color: black;color: black">
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-4">
                                                                    <div class="input-block mb-3">
                                                                        <label>FORK CLOSE TIME</label>
                                                                        <input type="time" class="form-control plAdd" id="<?php echo 'fork_close_time_'.$hlCount_id?>" name="<?php echo 'fork_close_time_'.$hlCount_id?>" value="<?php echo $fork_close_time?>" readonly style="border-color: black;color: black">
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-4">
                                                                    <div class="input-block mb-3">
                                                                        <label>VIBRATOR START TIME</label>
                                                                        <input type="time" class="form-control plAdd" id="<?php echo 'vibrator_start_time_'.$hlCount_id?>" name="<?php echo 'vibrator_start_time_'.$hlCount_id?>" value="<?php echo $vibrator_start_time?>" readonly style="border-color: black;color: black">
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-4">
                                                                    <div class="input-block mb-3">
                                                                        <label>VIBRATOR CLOSE TIME</label>
                                                                        <input type="time" class="form-control plAdd" id="<?php echo 'vibrator_close_time_'.$hlCount_id?>" name="<?php echo 'vibrator_close_time_'.$hlCount_id?>" value="<?php echo $vibrator_close_time?>" readonly style="border-color: black;color: black">
                                                                    </div>
                            ...
                            <form id="q1_form">
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <select name="material_type" id="material_typewet" name="material_typewet" class="form-control" value="<?php echo $material_typewet?>" disabled style="border-color: #181f5a;color: black">
                                                        ...
                                                        while($rowwetS = mysqli_fetch_assoc($resultwetS)) {
                                                            ...
                                                            <div class="row wetSInputs" id="<?php echo 'wetS_divRow_'.$wetSCount_id?>"><br>
                                                                ...
                                                                <div class="col-md-4">
                                                                    <div class="input-block mb-3">
                                                                        <label>DRY START TIME</label>
                                                                        <input type="time" class="form-control wetSAdd" id="<?php echo 'dry_start_time_'.$wetSCount_id?>" name="<?php echo 'dry_start_time_'.$wetSCount_id?>" value="<?php echo $dry_start_time?>" readonly style="border-color: black;color: black">
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-4">
                                                                    <div class="input-block mb-3">
                                                                        <label>DRY CLOSE TIME</label>
                                                                        <input type="time" class="form-control wetSAdd" id="<?php echo 'dry_close_time_'.$wetSCount_id?>" name="<?php echo 'dry_close_time_'.$wetSCount_id?>" value="<?php echo $dry_close_time?>" readonly style="border-color: black;color: black">
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-4">
                                                                    <div class="input-block mb-3">
                                                                        <label>LIQUID START TIME</label>
                                                                        <input type="time" class="form-control wetSAdd" id="<?php echo 'liquid_start_time_'.$wetSCount_id?>" name="<?php echo 'liquid_start_time_'.$wetSCount_id?>" value="<?php echo $liquid_start_time?>" readonly style="border-color: black;color: black">
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-4">
                                                                    <div class="input-block mb-3">
                                                                        <label>LIQUID CLOSE TIME</label>
                                                                        <input type="time" class="form-control wetSAdd" id="<?php echo 'liquid_close_time_'.$wetSCount_id?>" name="<?php echo 'liquid_close_time_'.$wetSCount_id?>" value="<?php echo $liquid_close_time?>" readonly style="border-color: black;color: black">
                                                                    </div>
                                                                </div>
                        ...
                        <div class="basic-form" style="color: black;">
                            <form id="q1_form">
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-4">
                                        <label>Paper Used</label>
                                        <select name="material_typedry" id="material_typedry" class="form-control" value="<?php echo $material_typedry?>"disabled style="border-color: #181f5a;color: black">
                                            <option value="Card Board">Card Board</option>
                                            <option value="Ceramic Paper">Ceramic Paper</option>
                                        </select>
                                    </div>
                            ...
                            <form id="q1_form">
                                <div class="form-row">
                                    <div class="form-group col-md-3">
                                        ...
                                        <input type="text" class="form-control" placeholder="Customer Name" id="customer_er" name="customer_er" value="<?php echo $customer_er ?>" required style="border-color: #181f5a;color: black;text-transform: uppercase">
                                    ...
                                    <div class="form-group col-md-3">
                                        <label>Material Type</label>
                                        <select name="material_typeer" id="material_typeer" class="form-control" value="<?php echo $service_add?>" required style="border-color: #181f5a;color: black">
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <input type="text" class="form-control" placeholder="Bricks Details" id="brickser" name="brickser" value="<?php echo $brickser?>" readonly style="border-color: #181f5a;color: black">
                                    </div>
                                    <div class="form-group col-md-3">
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <input type="text" class="form-control" placeholder="NO.OF.HEATS GONE" id="heat_gone" name="heat_gone" value="<?php echo $heat_gone?>" readonly style="border-color: #181f5a;color: black">
                                    </div>
                                    <div class="form-group col-md-3">
