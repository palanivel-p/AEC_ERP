                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-responsive-md" style="text-align: center;">
                            ...
                            if($product_id == "") {
                                $sql = "SELECT * FROM service WHERE visit_date  BETWEEN '$from_date' AND '$to_date' $addedBy ORDER BY id DESC LIMIT $start,10";
                            }
                            {
                                $sql = "SELECT * FROM service WHERE visit_date  BETWEEN '$from_date' AND '$to_date' $product_idSql $addedBy ORDER BY id DESC LIMIT $start,10";
                            }
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close" onclick="window.location.href='<?php echo $website ?>/service'">
                    ...
                    <div class="basic-form" style="color: black;">
                        <form id="filter_form" autocomplete="off">
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-12">
                                    <label>Customer Name </label>
                                    <input type="text"  class="form-control" id="cus_id" name="cus_id"  placeholder="Customer Name" style="border-color: #181f5a;color: black">
                                </div>
<!--                                <div class="form-group col-md-12">-->
<!--                                    <label>Customer Name </label>-->
