                ...
                <div class="card-body">
                    <div class="card-header">
                        ...
                        <div style="display: flex;justify-content: flex-end;">
                            <a href="<?php echo $website?>/People/Customers/"><button class="btn btn-danger" type="button">Close</button></a>
...
<script>
    ...
    var liElement = document.getElementById("active2");
    var aElement = document.getElementById("link2");
