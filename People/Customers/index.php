                        ...
                        <table class="table table-responsive-md" style="text-align: center;">
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="dropdown">
                                        <a href="<?php echo $website?>/People/Customers/show_file.php?customer_id=<?php echo $row['customer_id']?>"
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item" data-toggle="modal" data-target="#career_list" style="cursor: pointer" onclick="editTitle('<?php echo $row['customer_id'];?>')">Edit</a>
                                            <?php
                                            if($_COOKIE['role'] == 'Super Admin') {
                                            ?>
                                            <a class="dropdown-item" style="cursor: pointer" onclick="delete_model('<?php echo $row['customer_id'];?>')">Delete</a>
                                                <?php
                                            }
                                            ?>
                                        </div>
                        ...
                        <div class="col-12 pl-3" style="display: flex;justify-content: center;">
                            <nav>
                                <ul class="pagination pagination-gutter pagination-primary pagination-sm no-bg">
                                    ...
                                    {
                                        ?>
                                        <li class="page-item page-indicator"><a class="page-link" href="?page_no=<?php echo $prevPage?>&email=<?php echo $email ?>&c_code=<?php echo $c_code?>&mobile=<?php echo $mobile?>&c_name=<?php echo $c_name?>"><i class="fa-solid fa-less-than"></i></i></a></li>
                                        <?php
                                    }
                                    if($email == ""  && $mobile== "" && $c_name == "") {
                                        ...
                                        $sql = "SELECT COUNT(id) as count FROM customer WHERE id > 0 $emailSql$mobileSql$sCodeSql$sNameSql";
                                    }
//                                    $sql = 'SELECT COUNT(id) as count FROM customer;';
                                    $result = mysqli_query($conn, $sql);
                                    ...
                                    if (mysqli_num_rows($result)) {
                                        ...
                                        for ($i = 1; $i <= $pageFooter; $i++) {
                                            ...
                                            if($i<=($pageSql+10) && $i>$pageSql || $pageFooter<=10) {
                                                ...
                                                <li class="page-item <?php echo $active ?>"><a class="page-link"
                                                                                               href="?page_no=<?php echo $i ?>&email=<?php echo $email ?>&c_code=<?php echo $c_code?>&mobile=<?php echo $mobile?>&c_name=<?php echo $c_name?>"><?php echo $i ?></a>
                                                </li>
                                                <?php
                                            }
                                        }
                                        ...
                                        {
                                            ?>
                                            <li class="page-item page-indicator"><a class="page-link" href="?page_no=<?php echo $nextPage ?>&email=<?php echo $email ?>&c_code=<?php echo $c_code?>&mobile=<?php echo $mobile?>&c_name=<?php echo $c_name?>"><i class="fa-solid fa-greater-than"></i></a></li>
                                            <?php
                                        }
                                    }
                                    ?>
                            ...
                            <form id="career_form" autocomplete="off">
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6" id="sup_email">
                                        <label>Email *</label>
                                        <input type="email" class="form-control" placeholder="Email" id="customer_email" name="customer_email" onkeyup="myFunction()" style="border-color: #181f5a;color: black">
                                    </div>

                                    <div class="form-group col-md-6" id="sup_phone">
                                        <label>Phone 1 *</label>
                                        <input type="number" class="form-control" placeholder="Phone 1" id="customer_phone" name="customer_phone" style="border-color: #181f5a;color: black">
                                    </div>
                                    <div class="form-group col-md-6" id="sup_phone1">
                                        <label>Phone 2</label>
                                        <input type="number" class="form-control" placeholder="Phone 2" id="customer_phone1" name="customer_phone1" style="border-color: #181f5a;color: black">
                                    </div>
...
<!--                                        <input type="text" class="form-control" placeholder="Other country state" id="other_state" name="other_state" style="border-color: #181f5a;color: black;text-transform: uppercase">-->
<!--                                    </div>-->
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <button type="button" class="close" data-dismiss="modal" id="closeButton" onclick="myFunction()"><span>&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <div class="basic-form" style="color: black;">
                        <form id="filter_form" autocomplete="off">
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-12">
                                    <label>Customer Name </label>
                                    <input type="text"  class="form-control" placeholder="customer Name" id="c_name" name="c_name" style="border-color: #181f5a;color: black">
                                </div>
<!--                                <div class="form-group col-md-12">-->
<!--                                    <label>Customer Code </label>-->
<!--                                    <input type="text"  class="form-control" placeholder="customer Code" id="c_code" name="c_code" style="border-color: #181f5a;color: black">-->
<!--                                </div>-->
                                <div class="form-group col-md-12">
                                    <label>Mobile </label>
...
<script>
    ...
    $("#career_form").validate(
        {
            ...
            messages: {
                ...
                supply_place: "*This field is required",
    ...
    $(document).on("click", ".excel_download", function () {
        window.location.href = "excel_download.php?&c_name=<?php echo $c_name?>&c_code=<?php echo $c_code?>&mobile=<?php echo $mobile?>&email=<?php echo $email?>";
    });
    $(document).on("click", ".pdf_download", function () {
        window.location.href = "pdf_download.php?&c_name=<?php echo $c_name?>&c_code=<?php echo $c_code?>&mobile=<?php echo $mobile?>&email=<?php echo $email?>";
    });
</script>
