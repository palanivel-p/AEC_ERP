                ...
                <div class="card-body">
                    <div class="card-header">
                        ...
                        <div style="display: flex;justify-content: flex-end;">
                            <a href="<?php echo $website?>/People/Suppliers/"><button class="btn btn-danger" type="button">Close</button></a>
                            ...
                            <div class="col-12">
                                ...
                                <table class="table table-bordered" style="text-align: center;">
                                    ...
                                    <tr>
                                        ...
                                        <td><strong><?php echo $supplier_id;?></strong></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $row['supplier_phone1']?></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <th><strong>Place of Supply(India)</strong></th>
                                        <td><?php echo $row['supply_place']?></td>
                                    </tr>
                                    <tr>
                                        <th><strong>Bill To Address</strong></th>
                                        <td><?php echo $row['address1']?></td>
                                    </tr>
                                    <tr>
                                        <th><strong>Ship To Address</strong></th>
...
<script>
    ...
    var liElement = document.getElementById("active1");
    var aElement = document.getElementById("link1");
