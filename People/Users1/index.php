...
<!--                                <td> --><?php //echo $row['l_name']?><!-- </td>-->
                                ...
                                <td>  <a href="<?php echo $website ?>/People/Users/?userid=<?php echo $row['user_id']; ?>" class="btn btn-success">Documents</a>
                                </td>
                                ...
                                <td class="text-center">
                                    <div class="dropdown">
                                        <a href="<?php echo $website?>/People/Users/show_file.php?user_id=<?php echo $row['user_id']?>"
...
//                                    $sql = 'SELECT COUNT(id) as count FROM user;';
        ...
        <div class="modal fade" id="document_list" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group col-md-6">
                            ...
                            <button class="btn btn-primary" onclick="window.location.href='<?php echo $website ?>/People/Users/user_doc/?<?php echo $user_doc ?>1.pdf'">Document</button>
                        </div>
                        <div class="form-group col-md-6">
                            <label>Document 1</label>
                            <button class="btn btn-primary" onclick="window.location.href='<?php echo $website ?>/People/Users/user_doc/?<?php echo $user_doc ?>2.pdf'">Document</button>
                        </div>
                        <div class="form-group col-md-6">
                            <label>Document 1</label>
                            <button class="btn btn-primary" onclick="window.location.href='<?php echo $website ?>/People/Users/user_doc/?<?php echo $user_doc ?>3.pdf'">Document</button>
                        </div>
                        <div class="form-group col-md-6">
                            <label>Document 1</label>
                            <button class="btn btn-primary" onclick="window.location.href='<?php echo $website ?>/People/Users/user_doc/?<?php echo $user_doc ?>4.pdf'">Document</button>
                        </div>
                        <div class="form-group col-md-6">
                            <label>Document 1</label>
                            <button class="btn btn-primary" onclick="window.location.href='<?php echo $website ?>/People/Users/user_doc/?<?php echo $user_doc ?>5.pdf'">Document</button>
                        </div>
                    </div>
...
<!--                                    <div class="form-row">-->
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="file" class="form-control" placeholder="Upload Document" id="upload_doc2" name="upload_doc2" style="border-color: #181f5a;color: black" accept=".jpg,.jpeg,.png">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="upload_Document">Document(3)</label>
                                        <input type="file" class="form-control" placeholder="Upload Document" id="upload_doc3" name="upload_doc3" style="border-color: #181f5a;color: black" accept=".jpg,.jpeg,.png">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="upload_Document">Document(4)</label>
                                        <input type="file" class="form-control" placeholder="Upload Document" id="upload_doc4" name="upload_doc4" style="border-color: #181f5a;color: black" accept=".jpg,.jpeg,.png">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="upload_Document">Document(5)</label>
                                        <input type="file" class="form-control" placeholder="Upload Document" id="upload_doc5" name="upload_doc5" style="border-color: #181f5a;color: black" accept=".jpg,.jpeg,.png">
                                    </div>
                                    <div class="form-group col-md-6">
