                ...
                <div class="card-body">
                    <div class="card-header">
                        ...
                        <div style="display: flex;justify-content: flex-end;">
                            <a href="<?php echo $website?>/company_profile/"><button class="btn btn-danger" type="button">Close</button></a>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-12">
                                ...
                                $sql = "SELECT * FROM company_profile WHERE company_id='$company_id'";
                                ...
                                <table class="table table-bordered" style="text-align: center;">
                                    ...
                                    <tr>
                                        ...
                                        <td><strong><?php echo $company_id;?></strong></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <th><strong>Bank Name 1</strong></th>
                                        <td><?php echo $row['bank_name']?></td>
                                    </tr>
                                    <tr>
                                        <th><strong>Bank Name 2</strong></th>
                                        <td><?php echo $row['bank_name2']?></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <th><strong>Company Image</strong></th>
                                        <td><img src="<?php echo $website?>/company_profile/company_logo/<?php echo $company_id ?>.jpg" alt="Company Logo" style="width: 150px;"></td>
                                    </tr>
                                    <tr>
...
<script>
    ...
    var liElement = document.getElementById("active4");
    var aElement = document.getElementById("link4");
