                ...
                <div class="card-body">
                    <div class="card-header">
                        ...
                        <div style="display: flex;justify-content: flex-end;">
                            <a href="<?php echo $website?>/sale_shipment/"><button class="btn btn-danger" type="button">Close</button></a>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <?php
                                  ...
                                  $sql = "SELECT * FROM sale_shipment WHERE shipping_id='$shipping_id'";
                                ...
                                $date = $row['date'];
                                $date1 = $row['delivery_date'];
                                $date = date('d-m-Y', strtotime($date));
                                $delivery_date = date('d-m-Y', strtotime($date1));
                                ?>
                                <table class="table table-bordered dom" style="text-align: center;">
                                    <tbody>
                                    <tr>
                                        <th><strong>DC ID</strong></th>
                                        <td><strong><?php echo $shipping_id;?></strong></td>
                                    </tr>
                                    <tr>
                                        <th class="table_head"><strong>DC Date</strong></th>
                                        <td class="table_data"><?php echo $date?></td>
                                    </tr>
                                    <tr>
                                        <th class="table_head"><strong>Terms of Delivery</strong></th>
                                        <td class="table_data"><?php echo $row['terms_delivery']?></td>
                                    </tr>

                                    <tr>
                                        <th class="table_head"><strong>Expected Delivery Date</strong></th>
                                        <td class="table_data"><?php echo $delivery_date?></td>
                                    </tr>
                                    <tr>
                                        <th class="table_head"><strong>Dispatched through</strong></th>
                                        <td class="table_data"><?php echo $row['dispatched_through']?></td>
                                    </tr>
                                    <tr>
                                        <th class="table_head"><strong>Destination</strong></th>
                                        <td class="table_data"><?php echo $row['destination']?></td>
                                    </tr>
                                    <tr>
                                        <th class="table_head"><strong>Supplier Name</strong></th>
                                        <td class="table_data"><?php echo $row['supplier_name']?></td>
                                    </tr>
                                    <tr>
                                        <th class="table_head"><strong>Vehicle No</strong></th>
                                        <td class="table_data"><?php echo $row['vehicle_no']?></td>
                                    </tr>
                                    <tr>
                                        <th class="table_head"><strong>Shipping Amount</strong></th>
                                        <td class="table_data"><?php echo $row['shipping_amount']?></td>
                                    </tr>
                                    <tr>
                                        <?php
                                        ...
                                        if($other_charges==''){
                                            ...
                                            $other_charges1=$other_charges;
                                        }
                                        ?>
                                        <th class="table_head"><strong>Other Charges</strong></th>
                                        <td class="table_data"><?php echo $other_charges1 ?></td>
                                    </tr>
...
<script>
    ...
    var liElement = document.getElementById("active25");
    var aElement = document.getElementById("link25");
