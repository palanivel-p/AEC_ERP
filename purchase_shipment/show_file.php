            ...
            <div class="card">
                <div class="card-body">
                    <div class="card-header">
                        <h4 class="card-title">View / purchase Delivery challan</h4>
                        <div style="display: flex;justify-content: flex-end;">
                            <a href="<?php echo $website?>/purchase_shipment/"><button class="btn btn-danger" type="button">Close</button></a>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <?php
                                  ...
                                  $sql = "SELECT * FROM purchase_shipment WHERE shipping_id='$shipping_id'";
                                ...
                                $p_date = date('d-m-Y', strtotime($ps_date));
                                ...
                                <table class="table table-bordered dom" style="text-align: center;">
                                    ...
                                    <tr>
                                        ...
                                        <td class="table_data"><?php echo $p_date?></td>
                                    </tr>
                                    <tr>
