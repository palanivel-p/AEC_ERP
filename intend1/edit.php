...
<head>
    ...
    <title>Edit Intend profile</title>
                                        ...
                                        <table class="table table-hover">
                                            ...
                                            if (mysqli_num_rows($result)>0) {
                                                ...
                                                while($row = mysqli_fetch_assoc($result)) {
                                                    ...
                                                    $sqlProduct = "SELECT * FROM product WHERE product_id ='$product_code'";
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <select id="<?php echo $product_code.'_dynamicDropdown' ?>">
                                                            <option value="reason1" <?php echo ($reasonType == 'reason1') ? 'selected' : ''; ?>>Reason1</option>
                                                            <option value="reason2" <?php echo ($reasonType == 'reason2') ? 'selected' : ''; ?>>Reason2</option>
                                                            <option value="reason3" <?php echo ($reasonType == 'reason3') ? 'selected' : ''; ?>>Reason3</option>
                                                        </select>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <i class="fa fa-trash trash-icon" style="cursor: pointer;" onclick="removeProductAndRemoveRow(this, '<?php echo $product_id; ?>')"></i>
                                                    </td>
                                                </tr>
                                            <?php } }
        ...
        if($("#staff_form").valid()==true) {
            ...
            for (let i = 0; i < tableRows.length; i++) {
                ...
                const rowData = {
                    ...
                    reasonType: row.cells[6].querySelector('select').value,
                };
                ...
                success: function (res) {
                    if (res.status == 'success') {
                        Swal.fire(
                            ...
                            .then((value) => {
                                window.location.href = "all_intend.php";
