                        ...
                        <form id="staff_form" autocomplete="off">
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <select data-search="true" class="form-control tail-select w-full" id="supplier" name="supplier" style="border-color: #181f5a;color: black" onchange="supplierfun(this.value)">
                                        ...
                                        if (mysqli_num_rows($resultSupplier) > 0) {
                                            while ($rowSupplier = mysqli_fetch_array($resultSupplier)) {
                                                ?>
                                                <option
                                                    value='<?php echo $rowSupplier['supplier_id'].'_'.$rowSupplier['supply_place']; ?>'><?php echo strtoupper($rowSupplier['supplier_name']); ?></option>
                                                <?php
                                            }
                                        }
                                        ?>
