...
<!--                            </div>-->
                            <div class="form-group mx-sm-2 mb-1">
                                ...
                                <select  class="form-control" id="user_name" name="user_name" style="border-color: #181f5a;border-radius:20px;color:black;">
                                    <option value="">Select Staff Name</option>
                                    <?php
                                    $sqlDevice = "SELECT * FROM `user`";
                                    $resultDevice = mysqli_query($conn, $sqlDevice);
                                    if (mysqli_num_rows($resultDevice) > 0) {
                                        while ($rowDevice = mysqli_fetch_array($resultDevice)) {
                                            ?>
                                            <option
                                                    value='<?php echo $rowDevice['staff_id']; ?>'><?php echo strtoupper($rowDevice['f_name']); ?></option>
                                            <?php
                                        }
                                    }
                                    ?>
                            ...
                            <div class="form-group mx-sm-2 mb-1">
                                ...
                                <input class="form-control " type="date" id="from_date" name="from" style="border-color: #181f5a;border-radius:20px;color:black;" value=<?php echo $fdate ?> >
                            </div>
                            <div class="form-group mx-sm-2 mb-1">

                                <input class="form-control " type="date" name="to" id="to_date" style="border-color: #181f5a;border-radius:20px;color:black;" value=<?php echo $ldate  ?> >
                            </div>
...
<!--                                <th><strong>Action</strong></th>-->
                            ...
                            <?php
                            if($user_name == "") {
                                $sql = "SELECT * FROM attendance WHERE `date_time` BETWEEN '$from' AND '$to' ORDER BY id DESC LIMIT $start, 10";
                            }
                            else {
//                             echo   $sql = "SELECT * FROM attendance AS a JOIN `user` AS s ON a.emp_id = s.staff_id
//                                WHERE (a.emp_id LIKE '%$search%' OR s.f_name LIKE '%$search%') AND a.date_time BETWEEN '$from' AND '$to' ORDER BY id DESC LIMIT $start, 10";
                                $sql = "SELECT * FROM attendance WHERE emp_id = '$user_name' AND date_time BETWEEN '$from' AND '$to' ORDER BY id DESC LIMIT $start, 10";
                            }
                        ...
                        <div class="col-12 pl-3" style="display: flex;justify-content: center;">
                            <nav>
                                <ul class="pagination pagination-gutter pagination-primary pagination-sm no-bg">
                                    ...
                                    {
                                        ?>
                                        <li class="page-item page-indicator"><a class="page-link" href="?page_no=<?php echo $prevPage?>&user_name=<?php echo $user_name ?>&from=<?php echo $fdate ?>&to=<?php echo $ldate ?>"><i class="fa-solid fa-less-than"></i></a></li>
                                        <?php
                                    }
...
//                 JOIN staff AS s ON a.emp_id = s.staff_id WHERE (a.emp_id LIKE '%$user_name%' OR s.staff_name LIKE '%$search%')AND a.date_time BETWEEN '$from' AND '$to'";
                                        $sql = "SELECT COUNT(id) as count FROM attendance WHERE emp_id = '$user_name' AND date_time BETWEEN '$from' AND '$to'";
                                    ...
                                    if (mysqli_num_rows($result)) {
                                        ...
                                        for ($i = 1; $i <= $pageFooter; $i++) {
                                            ...
                                            if($i<=($pageSql+10) && $i>$pageSql || $pageFooter<=10) {
                                                ...
                                                <li class="page-item <?php echo $active ?>"><a class="page-link"
                                                                                               href="?page_no=<?php echo $i ?>&user_name=<?php echo $user_name ?>&from=<?php echo $fdate ?>&to=<?php echo $ldate ?>"><?php echo $i ?></a>
                                                </li>
                                                <?php
                                            }
                                        }
                                        ...
                                        {
                                            ?>
                                            <li class="page-item page-indicator"><a class="page-link" href="?page_no=<?php echo $nextPage ?>&user_name=<?php echo $user_name ?>&from=<?php echo $fdate ?>&to=<?php echo $ldate ?>"><i class="fa-solid fa-greater-than"></i></a></li>
                                            <?php
                                        }
                                    }
                                    ?>
