                        ...
                        <div class="col-xl-12">
                            <div class="auth-form">
                                <div class="text-center mb-3">
                                    <a href="javascript:void(0)"><img src="https://erp.aecindia.net/field_app/officew.png" alt="" style="height: 100px"></a>
                                </div>
            ...
            if (password != "") {
                ...
                if(/^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,3})+$/.test(email)) {
                    ...
                    $.ajax({
                        ...
                        type: "POST",
                        url: "https://erp.aecindia.net/field_app/login/login.php",
