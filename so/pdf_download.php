...
<!--<table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">-->
    <h2 style="text-align: center">So List</h2>
    ...
    <table id="example">
        ...
        <?php
//        if($pur_id == "" ) {
//            $sql = "SELECT * FROM so WHERE so_date  BETWEEN '$from_date' AND '$to_date' ORDER BY id DESC";
//        }
//        else {
//            $sql = "SELECT * FROM so WHERE so_date  BETWEEN '$from_date' AND '$to_date' $pur_idSql ORDER BY id DESC";
//        }
        if($pur_id == "" ) {
            $sql = "SELECT * FROM so WHERE so_date  BETWEEN '$from_date' AND '$to_date' ORDER BY id DESC";
        }
