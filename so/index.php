    ...
    <div class="content-body">
        <div class="page-titles" style="margin-left: 21px;">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="javascript:void(0)">So</a></li>
                        ...
                        <form id="staff_form" autocomplete="off">
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-4">
                                    <label> SO Date *</label>
                                    <input type="date" class="form-control" id="so_date" name="so_date" style="border-color: #181f5a;color: black;text-transform: uppercase">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <select data-search="true" class="form-control js-example-disabled-results tail-select w-full" id="customer" name="customer" style="border-color: #181f5a;color: black" onchange="supplierfun(this.value)">
        ...
        <!--        <div class="modal fade" id="purchase_list"  data-keyboard="false" data-backdropt</h5>-->
        <!--                        <button type="button" ="static">-->
        <!--            <div class="modal-dialog modal-dialog-centered" role="document">-->
        <!--                <div class="modal-content">-->
        <!--                    <div class="modal-header">-->
        <!--                        <h5 class="modal-title" id="titles">Uniclass="close" data-dismiss="modal"><span>&times;</span>-->
        <!--                        </button>-->
        <!--                    </div>-->
...
<script>
    ...
    function totalTDS(b){
        ...
        var totaltds = grandTotalCal(productDetailArr);
        // grand_total.value = totaldiscount - ((a/100) * totaldiscount);
        grand_total.value = totaltds - b;
    }
    ...
    $('#addbtn').click(function () {
        if ($("#purchase_form").valid()) {
            ...
            disPrice.innerHTML = dis_price.toFixed(2);
