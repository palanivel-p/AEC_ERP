        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">All So List</h4>
...
//                            $purchase_id =  $rowIntend['purchase_id'];
                            ...
                            $slae_ids = array(); // Array to store purchase IDs
                            ...
                            $statColors = 'success';
                            $date = $row['so_date'];
                            $so_date = date('d-m-Y', strtotime($date));
                            ?>
                            <tbody>
                            <tr>
...
<!--                                <td>-->
<!--                                    --><?php //if ($statCont !== 'NA'): ?>
<!--                                        <span class="badge badge-pill badge---><?php //echo $statColor?><!-- text-white"><a href="https://erp.aecindia.net/intend/intend_details.php?purchase_id=--><?php //echo $purchase_id?><!--" style="color: white;">--><?php //echo $statCont?><!--</a></span>-->
<!--                                    --><?php //else: ?>
...
<!--                <a href="https://erp.aecindia.net/so/so_details.php?sale_id=--><?php //echo $sale_id?><!--" style="color: white;">--><?php //echo $sale_id?><!--</a>-->
<!--            </span>-->
<!--                                            &nbsp;-->
<!--                                        --><?php //endforeach; ?>
<!--                                    --><?php //else: ?>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            <a class="dropdown-item" href="https://erp.aecindia.net/so_raise/index.php?so_id=<?php echo $so_id?>" style="cursor: pointer" >SO Raise</a>
...
//                                    $sql = "SELECT COUNT(id) as count FROM intend";
                                    if($pur_id == "" ) {
//                                $sql = "SELECT * FROM purchase  ORDER BY id  LIMIT $start,10";
                                        $sql = "SELECT COUNT(id) as count FROM so WHERE so_date  BETWEEN '$from_date' AND '$to_date'";

                                    }
                                    else {
                                        $sql = "SELECT COUNT(id) as count FROM so  WHERE so_date  BETWEEN '$from_date' AND '$to_date' $pur_idSql ";
                                    }
                                    $result = mysqli_query($conn, $sql);
    ...
    $('#email_btn').click(function () {
        ...
        if($("#email_form").valid()==true) {
            ...
            $.ajax({
                ...
                type: "POST",
                url: "https://erp.aecindia.net/email/index.php",
