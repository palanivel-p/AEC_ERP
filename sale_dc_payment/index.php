    ...
    <div class="content-body">
        <div class="page-titles" style="margin-left: 21px;">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="javascript:void(0)">Sale DC Payment</a></li>
            </ol>
        </div>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Sale DC Payment List</h4>
...
<!--                                <th><strong>Due Amount</strong></th>-->
                            ...
                            <?php
                            // $sql = "SELECT * FROM purchase_dc_payment ORDER BY id  LIMIT $start,10";

//                            if($e_category == "" && $s_name== "" && $pay_mode == "" && $ref_no=="" && $f_date =="" && $t_date =="") {
                                $sql = "SELECT * FROM sale_dc ORDER BY id DESC LIMIT $start,10";
//                            }
//                            else
//                            {
...
//                            }
                            ...
                            $sqlsale = "SELECT * FROM `sale_shipment` WHERE `sale_id`='$sale_id'";
                            $ressale = mysqli_query($conn, $sqlsale);
                            $rowsale = mysqli_fetch_assoc($ressale);
                            $g_total =  $rowsale['shipping_amount'];
                            $shipping_id =  $rowsale['shipping_id'];

                            $sqlcustomer = "SELECT * FROM `customer` WHERE `customer_id`='supplier_name'";
                            $rescustomer = mysqli_query($conn, $sqlcustomer);
                            $rowcustomer = mysqli_fetch_assoc($rescustomer);
                            $customer =  $rowcustomer['customer_name'];

//                            $sqlamount="SELECT SUM(pay_made) AS pay_made  FROM sale_dc WHERE repayment_id='$repayment_id'";
...
<!--                                    <div class="dropdown">-->
<!--                                        <a href="--><?php //echo $website?><!--/Ledgers/sale_dc_payment/show_file.php?sale_payment_id=--><?php //echo $row['sale_payment_id']?><!--"-->
...
//                                        $sqls = "SELECT COUNT(id) as count FROM purchase_dc_payment WHERE id>0 $addedBy";
                                    $sqls = "SELECT COUNT(id) as count FROM sale_dc ";
//                                }
//                                else
//                                {
