                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table table-responsive-md" style="text-align: center;">
                            ...
                            if($p_category == "" && $s_category== "") {
                                $sql = "SELECT * FROM category  ORDER BY id  LIMIT $start,10";
                            }
                            else {
                                   $sql = "SELECT * FROM category WHERE id > 0 $p_categorySql$s_categorySql ORDER BY id  LIMIT $start,10";
                            }
...
<!--                                <td>--><?php //echo $row['category_id']?><!--</td>-->
                                ...
                                <td class="text-center">
                                    <div class="dropdown">
                                        <a href="<?php echo $website?>/inventory/category/show_file.php?category_id=<?php echo $row['category_id']?>"
                                ...
                                <ul class="pagination pagination-gutter pagination-primary pagination-sm no-bg">
                                    ...
                                    if ($prevPage > 0) {
                                        ...
                                        <li class="page-item page-indicator"><a class="page-link"
                                                                                href="?page_no=<?php echo 1 ?>&p_category=<?php echo $p_category ?>&s_category=<?php echo $s_category ?>"><i class="fa-solid fa-angles-left"></i></a></li>
                                        <?php
                                    }
                                    ...
                                    {
                                        ?>
                                        <li class="page-item page-indicator"><a class="page-link" href="?page_no=<?php echo $prevPage?>&p_category=<?php echo $p_category ?>&s_category=<?php echo $s_category ?>"><i class="fa-solid fa-less-than"></i></a></li>
                                        <?php
                                    }
//                                    if($search == "") {
...
//                                     }
//                                     else {
//                                         $sql = "SELECT COUNT(id) as count FROM category WHERE sub_category LIKE '%$search%'";
//                                     }
                                    if($p_category == "" && $s_category== "") {
                                        $sql = "SELECT COUNT(id) as count FROM category";
                                    }
                                    else {
                                        $sql = "SELECT COUNT(id) as count FROM category WHERE id > 0 $p_categorySql$s_categorySql";
                                    }
                                    $result = mysqli_query($conn, $sql);
                                    ...
                                    if (mysqli_num_rows($result)) {
                                        ...
                                        for ($i = 1; $i <= $pageFooter; $i++) {
                                            ...
                                            if($i<=($pageSql+10) && $i>$pageSql || $pageFooter<=10) {
                                                ...
                                                <li class="page-item <?php echo $active ?>"><a class="page-link" href="?page_no=<?php echo $i ?>&p_category=<?php echo $p_category ?>&s_category=<?php echo $s_category ?>"><?php echo $i ?></a>
                                                </li>
                                                <?php
                                            }
                                        }
                                        ...
                                        {
                                            ?>
                                            <li class="page-item page-indicator"><a class="page-link" href="?page_no=<?php echo $nextPage ?>&p_category=<?php echo $p_category ?>&s_category=<?php echo $s_category ?>"><i class="fa-solid fa-greater-than"></i></a></li>
                                            <?php
                                        }
                                        if($nextPage<$pageFooter)
                                        {
                                            ?>
                                            <li class="page-item page-indicator"><a class="page-link" href="?page_no=<?php echo $pageFooter ?>&p_category=<?php echo $p_category ?>&s_category=<?php echo $s_category ?>"><i class="fa-solid fa-angles-right"></i></a></li>
                                            <?php
                                        }
                                    }
                                    ?>
                            ...
                            <form id="staff_form" autocomplete="off">
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="text" class="form-control" placeholder="Sub Category Name" id="sub_category" name="sub_category" style="border-color: #181f5a;color: black">
                                    </div>
...
<script>
                ...
                success: function(res){
                    if(res.status=='success')
                    {
                        ...
                        for(let i = 0;i<category_sub.length;i++){
                            ...
                            document.getElementById('s_category').appendChild(opt);
                        }
                        if(category_sub != undefined){
                            $("#s_category").val(sub_category);

                        }
                        $("#s_category").trigger("change");
                    }
   ...
   $("#staff_form").validate(
       {
           ...
           messages: {
               ...
               sub_category: "*This field is required",
           }
   ...
   $('#add_btn').click(function () {
    ...
    $(document).on("click", ".excel_download", function () {
        window.location.href = "excel_download.php?&c_id=<?php echo $c_id?>&p_category=<?php echo $p_category?>&s_category=<?php echo $s_category?>";
    });
    $(document).on("click", ".pdf_download", function () {
        window.location.href = "pdf_download.php?&c_id=<?php echo $c_id?>&p_category=<?php echo $p_category?>&s_category=<?php echo $s_category?>";
    });
</script>
