                                ...
                                if (mysqli_num_rows($result)) {
                                    ...
                                    for ($i = 1; $i <= $pageFooter; $i++) {
                                        ...
                                        if($i<=($pageSql+10) && $i>$pageSql || $pageFooter<=10) {
                                            ?>
                                            <li class="page-item <?php echo $active ?>"><a class="page-link" href="?page_no=<?php echo $i ?>&p_name=<?php echo $p_name ?>&p_code=<?php echo $p_code ?>&p_category=<?php echo $p_category ?>&s_category=<?php echo $s_category ?>&brand=<?php echo $brand ?>"><?php echo $i ?></a>
