            ...
            <div class="card">
                <div class="card-body">
                    <div class="card-header">
                        <h4 class="card-title">View / Currency profile</h4>
                        <div style="display: flex;justify-content: flex-end;">
                            <a href="<?php echo $website?>/inventory/currency/"><button class="btn btn-danger" type="button">Close</button></a>
                            ...
                            <div class="col-12">
                                ...
                                <table class="table table-bordered" style="text-align: center;">
                                    ...
                                    <tr>
                                        ...
                                        <td><strong><?php echo $currency_id;?></strong></td>
                                    </tr>
                                    <tr>
...
<script>
    ...
    var liElement = document.getElementById("active9");
    var aElement = document.getElementById("link9");
