...
<head>
    ...
    <title>Market Planner Calender-View</title>
...
<div id="main-wrapper">
    ...
    <?php
    $header_name ="Market-Planner Calender-View";
    ...
    <div class="content-body">
        <div class="page-titles" style="margin-left: 21px;">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="javascript:void(0)">Market Planner Calender-View</a></li>
            </ol>
        </div>
