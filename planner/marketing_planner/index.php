...
//$s_name= $_GET['s_name'];
$ver_s_date = '1770-01-01'; // Example start date, replace with your actual logic
$ver_e_date = date("Y-m-d");
    ...
    <div class="content-body">
        <div class="page-titles" style="margin-left: 21px;">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="javascript:void(0)">Market Planner</a></li>
            </ol>
        </div>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Market Planner List</h4>
                    <div style="display: flex;justify-content: flex-end;">
                        <form class="form-inline">

                        </form>
                        <a href="<?php echo $website; ?>/planner/marketing_planner/calender_view.php" class="btn btn-primary mb-2" style="color: white; text-decoration: none;">Calender View</a>
                    ...
                    <div class="table-responsive">
                        <table class="table table-responsive-md" style="text-align: center;">
                            ...
                            <tr>
                                ...
                                <th style="width: 9%;"><strong>Plan Date</strong></th>
                           ...
                           if($custom_name == "" && $m_person == "") {
                                 $sql = "SELECT * FROM marketing WHERE visit_status = 0 AND next_date > '$currentDate'$meet_personSql$custom_nameSql$addedBy ORDER BY next_date ASC LIMIT $start,10";
                              }
                            else{
                               $sql = "SELECT * FROM marketing WHERE visit_status = 0 AND next_date  BETWEEN '$from_date' AND '$to_date'$meet_personSql$custom_nameSql$addedBy ORDER BY next_date ASC LIMIT $start,10";
                             }
                            ...
                            $v_date = $row['next_date'];
                            $plan_date = date('d-m-Y', strtotime($v_date));
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            <a class="dropdown-item" data-toggle="modal" data-target="#visit_list" style="cursor: pointer" onclick="visit('<?php echo $v_date;?>','<?php echo $row['marketing_id'];?>','<?php echo $row['customer_name']?>')">Visit Report</a>
                                            <a class="dropdown-item" data-toggle="modal" data-target="#call_list" style="cursor: pointer" onclick="repayment('<?php echo $row['marketing_id']?>','<?php echo $row['customer_name']?>','<?php echo $row['next_date']?>','<?php echo $row['mobile']?>','<?php echo $row['meet_person']?>','<?php echo $row['communication']?>')">Reschedule</a>
                                            <?php
                        ...
                        <div class="col-12 pl-3" style="display: flex;justify-content: center;">
                            <nav>
                                <ul class="pagination pagination-gutter pagination-primary pagination-sm no-bg">
                                    ...
                                    {
                                        ?>
                                        <li class="page-item page-indicator"><a class="page-link" href="?page_no=<?php echo $prevPage?>&custom_name=<?php echo $custom_name ?>&m_person=<?php echo $m_person ?>&f_date=<?php echo $from_date?>&t_date=<?php echo $to_date?>"><i class="fa-solid fa-less-than"></i></a></li>
                                        <?php
                                    }
//                                    $sql = "SELECT COUNT(id) as count FROM market WHERE next_follow > '$currentDate'";
                                    if($custom_name == "" && $m_person == "") {
                                        ...
                                        $sql = "SELECT COUNT(id) as count FROM marketing WHERE next_date > '$currentDate'$meet_personSql$custom_nameSql";
                                    }
                                    else{
                                        //    $sql = "SELECT * FROM market WHERE visit_date  BETWEEN '$from_date' AND '$to_date' $product_idSql$addedBy ORDER BY id  LIMIT $start,10";
                                        $sql = "SELECT COUNT(id) as count FROM marketing WHERE next_date  BETWEEN '$from_date' AND '$to_date'$meet_personSql$custom_nameSql";
                                    }
                                    $result = mysqli_query($conn, $sql);
                                    ...
                                    if (mysqli_num_rows($result)) {
                                        ...
                                        for ($i = 1; $i <= $pageFooter; $i++) {
                                            ...
                                            if($i<=($pageSql+10) && $i>$pageSql || $pageFooter<=10) {
                                                ...
                                                <li class="page-item <?php echo $active ?>"><a class="page-link"
                                                                                               href="?page_no=<?php echo $i ?>&custom_name=<?php echo $custom_name ?>&m_person=<?php echo $m_person ?>&f_date=<?php echo $from_date?>&t_date=<?php echo $to_date?>"><?php echo $i ?></a>
                                                </li>
                                                <?php
                                            }
                                        }
                                        ...
                                        {
                                            ?>
                                            <li class="page-item page-indicator"><a class="page-link" href="?page_no=<?php echo $nextPage ?>&custom_name=<?php echo $custom_name ?>&m_person=<?php echo $m_person ?>&f_date=<?php echo $from_date?>&t_date=<?php echo $to_date?>"><i class="fa-solid fa-greater-than"></i></a></li>
                                            <?php
                                        }
                                    }
                                    ?>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="title">Planner</h5>
...
<!--                                    </div>-->
                                    <div class="form-group col-md-6" id="cu_name">
                                        <label>Customer Name*</label>
                                        <select data-search="true" class="form-control" id="customer_name" name="customer_name" style="border-color: #181f5a;color: black">
                                            ...
                                            <?php
                                           echo $sqlSupplier = "SELECT * FROM `market_profile` WHERE assigned_to = '$added_by'";
                        ...
                        <div class="basic-form" style="color: black;">
                            <form id="visit_form" autocomplete="off">
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6" id="v_dates">
                        ...
                        <div class="basic-form" style="color: black;">
                            <form id="call_form" autocomplete="off">
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label>Meet Person *</label>
                                        <input type="text" class="form-control" id="meeting" name="meeting" placeholder="Meet Person" style="border-color: #181f5a;color: black">
                                    </div>

                                    <div class="form-group col-md-6" id="s_product">
                                        <label>Mobile *</label>
                                        <input type="number" class="form-control" placeholder="Mobile" id="phone" name="phone" style="border-color: #181f5a;color: black">
                                    </div>

                                    <div class="form-group col-md-6" id="s_next">
                                        <label>Communication Through</label>
                                        <select data-search="true" class="form-control" id="comm" name="comm" style="border-color: #181f5a;color: black">
                                            <option value="call"> Call</option>
                                            <option value="visit"> Visit</option>
                                        </select>
                                    </div>
                                    <div class="form-group col-md-12" id="Notess">
                                        <label>Notes *</label>
                                        <textarea class="form-control" placeholder="Note" id="note" name="note" style="border-color: #181f5a; color: black"></textarea>
                    ...
                    <div class="basic-form" style="color: black;">
                        <form id="filter_form" autocomplete="off">
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-12">
                                    <label>Customer Name </label>
                                    <select data-search="true" class="form-control" id="custom_name" name="custom_name" style="border-color: #181f5a;color: black">
                                        <option value=""> Select Customer</option>
                                        <?php
                                        $sqlSupplier = "SELECT * FROM `market_profile`";
                                        $resultSupplier = mysqli_query($conn, $sqlSupplier);
                                ...
                                <div class="form-group col-md-12">
                                    <label>Market Person </label>
                                    <input type="text"  class="form-control" placeholder="Market Person" id="m_person" name="m_person" style="border-color: #181f5a;color: black">
                                </div>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const v_date = document.getElementById('v_dates');
    ...
    function visit(visit_date, marketing_id, customer_name) {
        ...
        $('#mark_id').val(marketing_id);
        // $('#cus_name').val(customer_name).prop('disabled', true);
        $('#cus_name').val(customer_name);
        $('#v_date').val(visit_date).attr('readonly', true);
    ...
    function editTitle(data) {
        ...
        $("#title").html("Edit Marketing- "+data);
        $('#expense_form')[0].reset();
        ...
        $.ajax({
            ...
            success: function(res){
                if(res.status=='success')
                {
                    $("#plan_date").val(res.next_date);
                    $("#customer_name").val(res.customer_name);
                    $("#meet").val(res.meet_person);
                    $('#mobile').val(res.mobile);
                    // $('#assigned').val(res.added_by);
                    ...
                    var edit_model_title = "Edit Marketing - "+data;
    ...
    function repayment(customer_id, customer_name,next,mobile,meet_person,comm) {
