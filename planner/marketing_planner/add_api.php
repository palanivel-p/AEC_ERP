...
//    $sqlValidateCookie="SELECT * FROM `user_details` WHERE panel_api_key='$api_key'";
    ...
    if (mysqli_num_rows($resValidateCookie) > 0) {
        ...
        $sqlInsert = "INSERT INTO `marketing`(`marketing_id`,`next_date`,`customer_name`,`communication`,`notes`,`mobile`,`meet_person`,`type`,`added_by`,`added_date`) 
                                            VALUES ('','$plan_date','$customer_name','$communication','$notes','$mobile','$meet','planner','$added_by','$added_date')";
...
//        file_get_contents($website . "portal/includes/log.php?api_key=$api_key&info=$info");
        ...
        $info = urlencode("Market Planner Added");
