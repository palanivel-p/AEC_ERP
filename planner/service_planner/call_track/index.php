                    ...
                    <div class="table-responsive">
                        <table class="table table-responsive-md" style="text-align: center;">
                            ...
                            if($call_person == "" && $custom_name == "") {
                                ...
                                $sql = "SELECT * FROM service WHERE `type` = 'call' $custom_nameSql$call_personSql ORDER BY visit_date DESC LIMIT $start,10";
                            }
                            else{
                                //  $sql = "SELECT * FROM market WHERE visit_date  BETWEEN '$from_date' AND '$to_date' $product_idSql$addedBy ORDER BY id  LIMIT $start,10";
                                $sql = "SELECT * FROM service WHERE `type` = 'call' AND visit_date  BETWEEN '$from_date' AND '$to_date'$custom_nameSql$call_personSql ORDER BY visit_date  LIMIT $start,10";
                            }
                        ...
                        <div class="col-12 pl-3" style="display: flex;justify-content: center;">
                            <nav>
                                <ul class="pagination pagination-gutter pagination-primary pagination-sm no-bg">
                                    ...
                                    if($call_person == "" && $custom_name == "") {
                                        //   $sql = "SELECT * FROM market WHERE visit_date  BETWEEN '$from_date' AND '$to_date'$addedBy ORDER BY id  LIMIT $start,10";
                                        $sql = "SELECT COUNT(id) as count FROM service WHERE `type` = 'call' $custom_nameSql$call_personSql";
                                    }
                                    else{
                                        //  $sql = "SELECT * FROM market WHERE visit_date  BETWEEN '$from_date' AND '$to_date' $product_idSql$addedBy ORDER BY id  LIMIT $start,10";
                                        $sql = "SELECT COUNT(id) as count FROM service WHERE `type` = 'call' AND visit_date  BETWEEN '$from_date' AND '$to_date'$custom_nameSql$call_personSql";
                                    }
    ...
    function editTitle(data) {
        ...
        $.ajax({
            ...
            success: function(res){
                ...
                {
                    $("#call_date").val(res.visit_date);
                    $("#customer_name").val(res.customer_name);
                    $("#meet").val(res.meet_whom);
                    $('#mobile').val(res.mobile);
                    $('#next_date').val(res.next_follow);
