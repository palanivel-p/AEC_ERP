                ...
                <div class="card-header">
                    ...
                    <div style="display: flex;justify-content: flex-end;">
                        ...
                        <div class="form-group mx-sm-3 mb-2">
                            ...
                            <div class="form-group mx-sm-3 mb-2">
                                <input type="hidden" class="form-control" placeholder="Search By Name" name="service_target_id" id="service_target_id" value="<?php echo $service_target_id?>" style="border-radius:20px;color:black;" >
                            </div>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-responsive-md" style="text-align: center;">
                            ...
                            if($product_id == "") {
                            $sql = "SELECT * FROM service_target_detail WHERE service_target_id='$service_target_id' ORDER BY id DESC LIMIT $start,10";
                                }
                                else{
                                    $sql = "SELECT * FROM service_target_detail WHERE service_target_id='$service_target_id' $product_idSql ORDER BY id  LIMIT $start,10";
...
//                            $sqlTargetD = "SELECT * FROM target_detail WHERE target_id='$target_id'";
                            ...
                            $sNo++;
                            $sqlTarget = "SELECT * FROM `service_target` WHERE `service_target_id`='$service_target_id'";
                        ...
                        <div class="col-12 pl-3" style="display: flex;justify-content: center;">
                            <nav>
                                <ul class="pagination pagination-gutter pagination-primary pagination-sm no-bg">
                                    ...
                                    {
                                        ?>
                                        <li class="page-item page-indicator"><a class="page-link" href="?page_no=<?php echo $prevPage?>&product_id=<?php echo $product_id ?>&service_target_id=<?php echo $service_target_id?>"><i class="fa-solid fa-less-than"></i></a></li>
                                        <?php
                                    }

                                 if($product_id == "") {
                                     $sql = "SELECT COUNT(id) as count FROM service_target_detail WHERE service_target_id='$service_target_id'";
                                            }
                                else{
                                    $sql = "SELECT COUNT(id) as count FROM service_target_detail WHERE service_target_id='$service_target_id' $product_idSql";
                                }
                                    ...
                                    if (mysqli_num_rows($result)) {
                                        ...
                                        for ($i = 1; $i <= $pageFooter; $i++) {
                                            ...
                                            if($i<=($pageSql+10) && $i>$pageSql || $pageFooter<=10) {
                                                ...
                                                <li class="page-item <?php echo $active ?>"><a class="page-link"
                                                                                               href="?page_no=<?php echo $i ?>&product_id=<?php echo $product_id ?>&service_target_id=<?php echo $service_target_id?>"><?php echo $i ?></a>
                                                </li>
                                                <?php
                                            }
                                        }
                                        ...
                                        {
                                            ?>
                                            <li class="page-item page-indicator"><a class="page-link" href="?page_no=<?php echo $nextPage ?>&product_id=<?php echo $product_id ?>&service_target_id=<?php echo $service_target_id?>"><i class="fa-solid fa-greater-than"></i></a></li>
                                            <?php
                                        }
                                    }
                                    ?>
