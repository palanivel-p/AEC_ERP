    ...
    <div class="content-body">
        <div class="page-titles" style="margin-left: 21px;">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="javascript:void(0)">Service Target</a></li>
            </ol>
        </div>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Service Target List</h4>
                    ...
                    <div class="table-responsive">
                        <table class="table table-responsive-md" style="text-align: center;">
                            ...
                            <tr>
                                ...
                                <th><strong>Service Person</strong></th>
...
//                                                        if($product_id == "") {
                            //                                $sql = "SELECT * FROM market WHERE visit_date  BETWEEN '$from_date' AND '$to_date'$addedBy ORDER BY id  LIMIT $start,10";
                                                                $sql = "SELECT * FROM service_target  ORDER BY id DESC LIMIT $start,10";
//                                                        }
//                                                        else{
...
//                                                        }
                            ...
                            $sqlVisit = "SELECT COUNT(*) AS visit_count FROM service WHERE MONTH(visit_date) = '$month_number'";
                            ...
                            $sqlCommitment = "SELECT SUM(commitment_value) AS sum_commitment FROM service WHERE MONTH(visit_date) = '$month_number'";
...
//                            }
                            ...
                            <tr>
                                ...
                                <td> <a href="product_detail.php?service_target_id=<?php echo $row['service_target_id'] ?>"><span class="badge badge-pill badge-success">View</span></a></td>
                                <?php
                                if($_COOKIE['role'] == 'Super Admin') {
                                    ?>
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item" style="cursor: pointer"
                                                   onclick="delete_model('<?php echo $row['service_target_id']; ?>')">Delete</a>
                                            </div>
                                        </div>
                                    </td>
                                    <?php
                        ...
                        <div class="col-12 pl-3" style="display: flex;justify-content: center;">
                            <nav>
                                <ul class="pagination pagination-gutter pagination-primary pagination-sm no-bg">
                                    ...
                                    //                                    if($product_id == "") {
                                    $sql = "SELECT COUNT(id) as count FROM target";
                                    //                                    }
                                    //                                    {
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="tit">Service Target</h5>
                            ...
                            <form id="expense_form" autocomplete="off">
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6" id="v_date">
                                        ...
                                        <input type="hidden" class="form-control"  id="service_target_id" name="service_target_id">
                                    </div>
                                    ...
                                    <div class="form-group col-md-6" >
                                        ...
                                        <input type="text" class="form-control" id="service_person" name="service_person" placeholder="Service Person" style="border-color: #181f5a;color: black">
                                    </div>
                                    <div class="form-group col-md-6">
                                        ...
                                        <select data-search="true" class="form-control" id="customer_name" name="customer_name" style="border-color: #181f5a;color: black">
                                            ...
                                            <?php
                                            $sqlSupplier = "SELECT * FROM `service_profile`";
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <!-- Close button -->
                    <a href="<?php echo $website?>/planner/service_target/"><button class="btn btn-danger" type="button"><span>&times;</span></button></a>
                ...
                <div class="modal-body">
                    <div class="basic-form" style="color: black;">
                        <form id="view_form" autocomplete="off">
                            <div class="form-row">
                                <?php
                                $service_target_id = $_GET['service_target_id'];
//                                $months = $_GET['months'];
//                                $month = '09'; // Or the value from your variable
//                                $year = date('Y');
                                if($plCounts > 0) {
                                    $sqlTargetD = "SELECT * FROM target_detail WHERE service_target_id='$service_target_id'";
                                    ...
                                    if (mysqli_num_rows($resultTargetD)>0) {
                                        ...
                                        while($rowTargetD = mysqli_fetch_assoc($resultTargetD)) {
                                            ...
                                            $sqlTarget = "SELECT * FROM `target` WHERE `service_target_id`='$service_target_id'";
...
//                                          echo  $sqlAchievedQty = "SELECT SUM(qty) AS sum_qty FROM `sale_details` WHERE product_id = '$product_id' AND sale_date = '$months'";
                ...
                <div class="modal-footer">
                    <a href="<?php echo $website?>/planner/service_target/"><button class="btn btn-danger" style="background-color: red; color: white;text-transform: uppercase" type="button"><span>Close</span></button></a>
...
<script>
    ...
    function status_fun(data , month_name) {
        ...
        if (!params.has('service_target_id') || !params.has('month_name')) {
            window.location.href = "https://erp.aecindia.net/planner/service_target/?service_target_id=" + data + "&month_name=" + month_name;
        }
    }
    ...
    var sts = '<?php echo  $_GET['service_service_target_id']?>';
    ...
    $("#expense_form").validate(
        {
            ...
            messages: {
                service_person: "*Please Enter service Person Name",
            ...
            .then((value) => {
                if(value.isConfirmed) {
                    ...
                    $.ajax({
                        ...
                        type: "POST",
                        url: "delete_api.php",
                        data: 'service_service_target_id='+data,
                        dataType: "json",
                        success: function(res){
                            if(res.status=='success')
                            {
