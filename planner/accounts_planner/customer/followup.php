...
<div id="main-wrapper">
    ...
    <?php
    $header_name ="Customer Follow Up";
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-responsive-md" style="text-align: center;">
                            ...
                            $sql = "SELECT * FROM follow_up WHERE type ='customer' ORDER BY id DESC LIMIT $start,10";
                            //                            }
                            //                            else {
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            if($_COOKIE['role'] == 'Super Admin'|| $_COOKIE['role'] == 'Admin'|| $_COOKIE['role'] == 'Sales'|| $_COOKIE['role'] == 'Stores') {
                                                ?>
                                                <a class="dropdown-item" data-toggle="modal" data-target="#career_list" style="cursor: pointer" onclick="editTitle('<?php echo $row['followup_id'];?>')">Edit</a>
                                                <?php
                                            }
                                            ?>
                                        </div>
                        ...
                        <div class="col-12 pl-3" style="display: flex;justify-content: center;">
                            <nav>
                                <ul class="pagination pagination-gutter pagination-primary pagination-sm no-bg">
                                    ...
                                    $sql = "SELECT COUNT(id) as count FROM follow_up WHERE type ='customer'";
                            ...
                            <form id="follow_form" autocomplete="off">
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="date" class="form-control" id="date_time" name="date_time" style="border-color: #181f5a;color: black">
...
<!--                                    </div>-->
<!--                                    <div class="form-group col-md-3">-->
<!--                                        <select class="form-control default-select" name="start_from_sec" id="min_startTime">-->
<!--                                            <option value="00">00</option>-->
<!--                                            <option value="01">01</option>-->
<!--                                            <option value="02">02</option>-->
<!--                                            <option value="03">03</option>-->
...
<!--                                    </div>-->
<!--                                    <div class="form-group col-md-3">-->
<!--                                        <select class="form-control default-select" name="start_from_am" id="s_startTime">-->
