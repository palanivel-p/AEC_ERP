...
//                            if($brand == "" && $p_code == "" && $s_category== "" && $p_category == ""&& $p_name == "") {
                                $sql = "SELECT * FROM sale ORDER BY id DESC LIMIT $start,10";
//                            }
//                            else {
...
//                            $new_due_date_timestamp = strtotime($d_date) + (7 * 24 * 60 * 60);
//                            // Format the new due date
//                            $new_due_date = date('d-m-Y', $new_due_date_timestamp);
                        ...
                        <td>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    if($_COOKIE['role'] == 'Super Admin'|| $_COOKIE['role'] == 'Admin'|| $_COOKIE['role'] == 'Sales'|| $_COOKIE['role'] == 'Stores') {
                                        ?>
                                        <a class="dropdown-item" href="<?php echo $website; ?>/planner/accounts_planner/customer/followup.php?customer=<?php echo $Customer_name?>&invoice_no=<?php echo $invoice?>" style="cursor: pointer" >Follow Up</a>
                                        <a class="dropdown-item" data-toggle="modal" data-target="#career_list" style="cursor: pointer" onclick="editTitle('<?php echo $Customer_name;?>','<?php echo $invoice;?>','<?php echo $grand_total;?>','<?php echo $d_date;?>','<?php echo $next_date;?>')">Edit</a>
                                        <?php
                                    }
                                    ?>
                                    <?php
