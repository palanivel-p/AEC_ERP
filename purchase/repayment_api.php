...
if (mysqli_num_rows($resValidateCookie) > 0) {
    ...
    $sqlInsert = "INSERT INTO `purchase_payment`(`purchase_id`,`repayment_date`,`pay_made`,`repayment_mode`,`ref_no`,`ref_no_c`,`notes`,`tds`) 
                                            VALUES ('$purchase_id','$repayment_date','$pay_made','$repayment_mode','$ref_no','$ref_no_c','$notes','$tds')";
