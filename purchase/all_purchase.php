...
<script>
    ...
    $(document).ready(function(){
        ...
        $(document).on('keyup', ".p_mat", function() {
            ...
            // Check if materialReceived is greater than inputQtyValue
            if (materialReceived > inputQtyValue) {
                // Show an error message or handle the error as needed
                alert('Received Material cannot be greater than Quantity.');
                ...
                if(res.status == 'success') {
                    ...
                    res.data.forEach(function(item) {
                        ...
                        <div class="form-row formrow">
                            ...
                            <div class="form-group col-md-2">
                                <label>Quantity</label>
                                <input type="number" class="form-control p_qty" placeholder="Qty" readonly value="${item.status_qty}" style="border-color: #181f5a; color: black">
                            </div>
                            <div class="form-group col-md-2">
                                <label>Received</label>
