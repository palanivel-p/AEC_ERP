...
//    $sqlValidateCookie="SELECT * FROM `user_details` WHERE panel_api_key='$api_key'";
    ...
    if (mysqli_num_rows($resValidateCookie) > 0) {
        ...
        $sqlInsert = "INSERT INTO `purchase`(`purchase_id`,`intend_id`,`supplier`,`purchase_date`,`discount`,`tds`,`grand_total`,`payment_status`,`notes`,`status`,`material_date`,`payment_terms`,`currency_id`,`due_date`,`total_tax`,`added_by`) 
                                            VALUES ('','$intend_id','$supplier_id','$purchase_date','$discount','$tds','$grand_total','$payment_status','$notes','$status','$material','$payment_terms','$currency','$d_date','$totaltax','$added_by')";
        ...
        $purchase_id="PR".($ID);
        $invoice_no = "AEC/PO/" . $currentDate . "/" . $ID;
