            ...
            <div class="card">
                <div class="card-body">
                    <div class="card-header">
                        <h4 class="card-title">View / Expense Category</h4>
                        <div style="display: flex;justify-content: flex-end;">
                            <a href="<?php echo $website?>/Ledgers/expense_category/"><button class="btn btn-danger" type="button">Close</button></a>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <?php
                                  ...
                                  $sql = "SELECT * FROM expense_category WHERE category_id='$category_id'";
                                ...
                                $expense_date = date('d-m-Y', strtotime($e_date));
                                $d_date=$row['due_date'];
                                ...
                                <table class="table table-bordered" style="text-align: center;">
                                    ...
                                    <!--                                    </tr>-->
                                    <tr>
                                        <th class="table_head"><strong>Category Id</strong></th>
                                        <td class="table_body"><?php echo $category_id?></td>
                                    </tr>
                                    <tr>
