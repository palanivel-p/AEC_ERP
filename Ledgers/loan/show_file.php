                ...
                <div class="card-body">
                    <div class="card-header">
                        ...
                        <div style="display: flex;justify-content: flex-end;">
                            <a href="<?php echo $website?>/Ledgers/loan/"><button class="btn btn-danger" type="button">Close</button></a>
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <table class="table table-bordered" style="text-align: center;">
                                    ...
                                    <!--                                    </tr>-->
                                    <tr>
                                        <th class="table_head"><strong>Loan Id</strong></th>
                                        <td class="table_data"><?php echo $row['loan_id']?></td>
                                    </tr>
                                    <tr>
                                        <th class="table_head"><strong>Loan Date</strong></th>
                                        <td> class="table_data"<?php echo $loan_date?></td>
                                    </tr>
                                    <tr>
                                        <th class="table_head"><strong>Borrower</strong></th>
                                        <td class="table_data"><?php echo $row['borrower']?></td>
                                    </tr>

                                    <tr>
                                        <th class="table_head"><strong>Loan Amount</strong></th>
