                                ...
                                <ul class="pagination pagination-gutter pagination-primary pagination-sm no-bg">
                                    ...
                                    if ($prevPage > 0) {
                                        ...
                                        <li class="page-item page-indicator">
                                            <a class="page-link" href="?page_no=1&l_id=<?php echo $l_id; ?>&b_name=<?php echo urlencode($b_name); ?>&f_date=<?php echo $f_date; ?>&t_date=<?php echo $t_date; ?>">
                                                <i class="fa-solid fa-angles-left"></i>
                                            </a>
                                        </li>
                                        <li class="page-item page-indicator">
                                            <a class="page-link" href="?page_no=<?php echo $prevPage; ?>&l_id=<?php echo $l_id; ?>&b_name=<?php echo urlencode($b_name); ?>&f_date=<?php echo $f_date; ?>&t_date=<?php echo $t_date; ?>">
                                    ...
                                    $sql = ($b_name == "")
                                        ? "SELECT COUNT(id) as count FROM loan WHERE loan_date BETWEEN '$from_date' AND '$to_date' $addedBy"
                                        : "SELECT COUNT(id) as count FROM loan WHERE loan_date BETWEEN '$from_date' AND '$to_date' $b_nameSql $addedBy";
                                    ...
                                    if ($result && mysqli_num_rows($result) > 0) {
                                        ...
                                        for ($i = 1; $i <= $pageFooter; $i++) {
                                            ...
                                            if ($i <= ($pageSql + 10) && $i > $pageSql || $pageFooter <= 10) {
                                                ...
                                                <li class="page-item <?php echo $active; ?>">
                                                    <a class="page-link" href="?page_no=<?php echo $i; ?>&l_id=<?php echo $l_id; ?>&b_name=<?php echo urlencode($b_name); ?>&f_date=<?php echo $f_date; ?>&t_date=<?php echo $t_date; ?>">
                                                        <?php echo $i; ?>
                                                    </a>
                                                </li>
                                                <?php
                                        ...
                                        if ($nextPage <= $pageFooter) {
                                            ?>
                                            <li class="page-item page-indicator">
                                                <a class="page-link" href="?page_no=<?php echo $nextPage; ?>&l_id=<?php echo $l_id; ?>&b_name=<?php echo urlencode($b_name); ?>&f_date=<?php echo $f_date; ?>&t_date=<?php echo $t_date; ?>">
                                        ...
                                        if ($page < $pageFooter) {
                                            ?>
                                            <li class="page-item page-indicator">
                                                <a class="page-link" href="?page_no=<?php echo $pageFooter; ?>&l_id=<?php echo $l_id; ?>&b_name=<?php echo urlencode($b_name); ?>&f_date=<?php echo $f_date; ?>&t_date=<?php echo $t_date; ?>">
