...
//                                        $sqls = "SELECT COUNT(id) as count FROM expense";
                                ...
                                if (mysqli_num_rows($results)) {
                                    ...
                                    for ($i = 1; $i <= $pageFooter; $i++) {
                                        ...
                                        if($i<=($pageSql+10) && $i>$pageSql || $pageFooter<=10) {
                                            ...
                                            <li class="page-item <?php echo $active ?>"><a class="page-link"
                                                                                           href="?page_no=<?php echo $i ?>&e_category=<?php echo $e_category ?>&sts_name=<?php echo $s_name ?>&pay_mode=<?php echo $pay_mode?>&ref_no=<?php echo $ref_no?>&f_date=<?php echo $f_date?>&t_date=<?php echo $t_date?>"><?php echo $i ?></a>
                                            </li>
                                            <?php
                                        }
                                    }
                                    ...
                                    {
                                        ?>
                                        <li class="page-item page-indicator"><a class="page-link" href="?page_no=<?php echo $nextPage ?>&e_category=<?php echo $e_category ?>&sts_name=<?php echo $s_name ?>&pay_mode=<?php echo $pay_mode?>&ref_no=<?php echo $ref_no?>&f_date=<?php echo $f_date?>&t_date=<?php echo $t_date?>"><i class="fa-solid fa-greater-than"></i></a></li>
                                        <?php
                                    }
                                }
                                ?>
...
<script>
    ...
    $(document).on("click", ".excel_download", function () {
        window.location.href = "excel_download.php?&expense_id=<?php echo $expense_id?>&e_category=<?php echo $e_category?>&sts_name=<?php echo $s_name?>&pay_mode=<?php echo $pay_mode?>&ref_no = <?php echo $ref_no?>&f_date=<?php echo $from_date?>&t_date=<?php echo $to_date?>";
    });
    $(document).on("click", ".pdf_download", function () {
        window.location.href = "pdf_download.php?&expense_id=<?php echo $expense_id?>&e_category=<?php echo $e_category?>&sts_name=<?php echo $s_name?>&pay_mode=<?php echo $pay_mode?>&ref_no = <?php echo $ref_no?>&f_date=<?php echo $from_date?>&t_date=<?php echo $to_date?>";
    });
