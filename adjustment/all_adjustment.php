...
<head>
    ...
    <title>All Adjustment profile</title>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Adjustment List</h4>
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table table-responsive-md" style="text-align: center;">
                            ...
                            <tr>
                                ...
                                <th><strong>Adjustment Id</strong></th>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="dropdown">
                                        <a href="<?php echo $website?>/adjustment/show_file.php?adjustment_id=<?php echo $row['adjustment_id']?>"
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            if($_COOKIE['role'] == 'Super Admin'|| $_COOKIE['role'] == 'Admin'|| $_COOKIE['role'] == 'Sales'|| $_COOKIE['role'] == 'Stores') {
                                            ?>
                                            <a class="dropdown-item" href="<?php echo $website; ?>/adjustment/edit.php?adjustment_id=<?php echo $adjustment_id?>" style="cursor: pointer" >Edit</a>
                                                <?php
                                            }
                                            ?>
                                            <?php
                                            if($_COOKIE['role'] == 'Super Admin') {
                                            ?>
                                            <a class="dropdown-item" style="cursor: pointer" onclick="delete_model('<?php echo $adjustment_id;?>')">Delete</a>
                                                <?php
                                            }
                                            ?>
                                        </div>
                                ...
                                <ul class="pagination pagination-gutter pagination-primary pagination-sm no-bg">
                                    ...
                                    if ($prevPage > 0) {
                                        ...
                                        <li class="page-item page-indicator"><a class="page-link"
                                                                                href="?page_no=<?php echo 1 ?>&a_id=<?php echo $a_id ?>&f_date=<?php echo $from_date?>&t_date=<?php echo $to_date?>"><i class="fa-solid fa-chevrons-left"></i></a></li>
                                        <?php
                                    }
                                    ...
                                    {
                                        ?>
                                        <li class="page-item page-indicator"><a class="page-link" href="?page_no=<?php echo $prevPage?>&a_id=<?php echo $a_id ?>&f_date=<?php echo $from_date?>&t_date=<?php echo $to_date?>"><i class="fa-solid fa-less-than"></i></a></li>
                                        <?php
                                    }
                                    if($a_id == "" && $f_reason == "") {
                                        $sql = "SELECT COUNT(id) as count FROM adjustment WHERE adjustment_date  BETWEEN '$from_date' AND '$to_date' ORDER BY id DESC";
                                    }
                                    else {
                                        $sql = "SELECT COUNT(id) as count FROM adjustment WHERE adjustment_date  BETWEEN '$from_date' AND '$to_date' $a_idSql$reasonSql ORDER BY id DESC";
                                    }
//                                    if($a_id == "" && $f_reason == "" ) {
//                                        $sql = "SELECT COUNT(id) as count FROM adjustment WHERE adjustment_date  BETWEEN '$from_date' AND '$to_date'$addedBy";
//                                    }
//                                    else {
//                                        $sql = "SELECT COUNT(id) as count FROM adjustment WHERE id > 0 adjustment_date  BETWEEN '$from_date' AND '$to_date' $a_id$reasonSql$addedBy";
//                                    }
                                    $result = mysqli_query($conn, $sql);
                                    ...
                                    if (mysqli_num_rows($result)) {
                                        ...
                                        for ($i = 1; $i <= $pageFooter; $i++) {
                                            ...
                                            if($i<=($pageSql+10) && $i>$pageSql || $pageFooter<=10) {
                                                ...
                                                <li class="page-item <?php echo $active ?>"><a class="page-link"
                                                                                               href="?page_no=<?php echo $i ?>&a_id=<?php echo $a_id ?>&f_date=<?php echo $from_date?>&t_date=<?php echo $to_date?>"><?php echo $i ?></a>
                                                </li>
                                                <?php
                                            }
                                        }
                                        ...
                                        {
                                            ?>
                                            <li class="page-item page-indicator"><a class="page-link" href="?page_no=<?php echo $nextPage ?>&a_id=<?php echo $a_id ?>&f_date=<?php echo $from_date?>&t_date=<?php echo $to_date?>"><i class="fa-solid fa-greater-than"></i></a></li>
                                            <?php
                                        }
                                        if($nextPage<$pageFooter)
                                        {
                                            ?>
                                            <li class="page-item page-indicator"><a class="page-link" href="?page_no=<?php echo $pageFooter ?>&a_id=<?php echo $a_id ?>&f_date=<?php echo $from_date?>&t_date=<?php echo $to_date?>"><i class="fa-solid fa-angles-right"></i></a></li>
                                            <?php
                                        }
                                    }
                                    ?>
                        ...
                        <form id="filter_form" autocomplete="off">
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text"  class="form-control" placeholder="Adjustment Id" id="a_id" name="a_id" style="border-color: #181f5a;color: black">
                                </div>
                                <div class="form-group col-md-12">
...
<script>
    ...
    $(document).on("click", ".excel_download", function () {
        window.location.href = "excel_download.php?&a_id=<?php echo $a_id?>&f_date=<?php echo $f_date?>&t_date=<?php echo $t_date?>&reason=<?php echo $f_reason?>";
    });
    $(document).on("click", ".pdf_download", function () {
        window.location.href = "pdf_download.php?&a_id=<?php echo $a_id?>&f_date=<?php echo $f_date?>&t_date=<?php echo $t_date?>&reason=<?php echo $f_reason?>";
    });
