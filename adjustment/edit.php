...
$sqlPurchase = "SELECT * FROM adjustment WHERE adjustment_id ='$adjustment_id'";
$resPurchase = mysqli_query($conn, $sqlPurchase);
$rowPurchase = mysqli_fetch_assoc($resPurchase);
$adjustment_date =  $rowPurchase['adjustment_date'];
$notes=$rowPurchase['notes'];
$reason=$rowPurchase['reason'];
if($reason == ''){
    $res ='Others';
}
else{
...
$other_reason=$rowPurchase['other_reason'];
?>
...
<head>
    ...
    <title>Edit Adjustment profile</title>
    ...
    <div class="content-body">
        <div class="page-titles" style="margin-left: 21px;">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="javascript:void(0)">Edit Adjustment</a></li>
                        ...
                        <form id="staff_form" autocomplete="off">
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-4" id="adj_date">
                                    ...
                                    <input type="date" class="form-control" id="adjustment_date" name="adjustment_date" value="<?php echo $adjustment_date?>" style="border-color: #181f5a;color: black;text-transform: uppercase">
                                    <input type="hidden" class="form-control"  id="api" name="api">
                                    <input type="hidden" class="form-control"  id="old_pa_id" name="old_pa_id">
                                    <input type="hidden" class="form-control"  id="adjustment_id" name="adjustment_id" value="<?php echo $adjustment_id?>">
                                ...
                                <div class="form-group col-md-12" style="font-size: 15px">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-hover">
                                            ...
                                            <tbody id="tb">
                                            <?php
                                            $sql = "SELECT * FROM adjustment_details WHERE adjustment_id ='$adjustment_id'";
...
//                                                    $product_name=$row['product_name'];
                                                    ...
                                                    $product_objs .= "$product_id,$product_code,$qty,$product_name"."#";
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span><?php echo $stock_qty?> </span>
                                                        <span id="<?php echo $product_code.'_stkid' ?>">-<?php echo $product_unit; ?></span>
                                                    </td>
                                                    <td id="<?php echo $product_code.'_bunit' ?>"><?php echo $base_unit;?></td>
                                                    <td id="<?php echo $product_code.'_quantity' ?>"><?php echo $qty;?></td>
                                                    <td>
                                                        <select id="<?php echo $product_code.'_addsub' ?>">
                                                            <option value="addition" <?php echo ($adjustment_type == 'addition') ? 'selected' : ''; ?>>Addition</option>
                                                            <option value="subtraction" <?php echo ($adjustment_type == 'subtraction') ? 'selected' : ''; ?>>Subtraction</option>
                                                        </select>
                                                    </td>
                                                    <td id="<?php echo $product_code.'_dynamicDropdown' ?>"><?php echo $reasons;?></td>

                                                    <td>
                                                        <i data-toggle="modal" data-target="#purchase_list" onclick="editTitle('<?php echo $product_code; ?>')" class="fa fa-edit edit-icon" style="cursor: pointer;"></i>
                                                    </td>
                                                    <td>
                                                        <i class="fa fa-trash trash-icon" style="cursor: pointer;" onclick="removeProductAndRemoveRow(this, '<?php echo $product_code; ?>')"></i>
                                                    </td>
                                                </tr>
                                            <?php } }
                                ...
                                <div class="form-group col-md-6" id="ress">
                                    ...
                                    <select class="form-control" id="res" name="res" style="border-color: #181f5a; color: black">
                                        <option value="Expired" <?php echo ($res == 'Expired') ? 'selected' : ''; ?>>Expired</option>
                                        <option value="Damaged" <?php echo ($res == 'Damaged') ? 'selected' : ''; ?>>Damaged</option>
                                        <option value="Initial Stock" <?php echo ($res == 'Initial Stock') ? 'selected' : ''; ?>>Initial Stock</option>
                                        <option value="Sample Material" <?php echo ($res == 'Sample Material') ? 'selected' : ''; ?>>Sample Material</option>
                                        <option value="Others" <?php echo ($res == 'Others') ? 'selected' : ''; ?>>Others</option>
                                    </select>
                                </div>

                                <div class="form-group col-md-6" id="other_ress" style="display: none">
                                    <label>Other Reason</label>
                                    <input type="text" class="form-control" id="other_res" name="other_res" value="<?php echo $other_reason ?>" style="border-color: #181f5a;color: black;text-transform: uppercase">
                                </div>
                            </div>
                        </form>
                    </div>
                        ...
                        <div class="basic-form" style="color: black;">
                            <form id="purchase_form" autocomplete="off">
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-12" id="qtyss">
                                    ...
                                    <div class="form-group col-md-12" id="units">
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        //remove row
        function removeProductAndRemoveRow(iconElement, productId) {
            // const indexToRemove = gArray.indexOf(productId);
            // if (indexToRemove !== -1) {
            //     gArray.splice(indexToRemove, 1);
            // }
            let obj = productDetailArr.findIndex(o => o.productId === productId);
            productDetailArr.splice(obj,1);
            gArray.splice(obj,1);
            grandTotalCal(productDetailArr);
            // Find the closest 'tr' element relative to the iconElement
                ...
                success: function (res) {
                    if (res.status == 'success') {
                        ...
                        for(let i=0;i<product_id.length;i++){
                            ...
                            // listUL.innerHTML = product_name[i] + "-" + brand_type[i];
