...
<head>
    ...
    <title>Purchase Return Payment</title>
...
<div id="main-wrapper">
    ...
    <?php
    $header_name ="Purchase Return Payment";
    ...
    <div class="content-body">
        <div class="page-titles" style="margin-left: 21px;">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="javascript:void(0)">Purchase Return Payment</a></li>
            </ol>
        </div>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Purchase Return Payment List</h4>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-responsive-md" style="text-align: center;">
                            ...
                            <?php
                            // $sql = "SELECT * FROM purchase_return_payment ORDER BY id  LIMIT $start,10";

//                            if($e_category == "" && $s_name== "" && $pay_mode == "" && $ref_no=="" && $f_date =="" && $t_date =="") {
                                $sql = "SELECT * FROM purchase_return_payment  ORDER BY id DESC LIMIT $start,10";
//                            }
//                            else
//                            {
//                                $sql = "SELECT * FROM purchase_return_payment WHERE purchase_payment_date  BETWEEN '$from_date' AND '$to_date' $e_categorySql$s_nameSql$pay_modeSql$ref_noSql$addedBy ORDER BY id DESC LIMIT $start,10";
//                            }
                            ...
                            $sqlpurchase = "SELECT * FROM `purchase_return` WHERE `purchase_id`='$purchase_id'";
...
<!--                                    <div class="dropdown">-->
<!--                                        <a href="--><?php //echo $website?><!--/Ledgers/purchase_return_payment/show_file.php?purchase_payment_id=--><?php //echo $row['purchase_payment_id']?><!--"-->
...
//                                if($e_category == "" && $s_name== "" && $pay_mode == "" && $ref_no=="" && $f_date =="" && $t_date =="") {
//                                        $sqls = "SELECT COUNT(id) as count FROM purchase_return_payment WHERE id>0 $addedBy";
                                    $sqls = "SELECT COUNT(id) as count FROM purchase_return_payment ";

//                                }
//                                else
//                                {
//                                    $sqls = "SELECT COUNT(id) as count FROM purchase_return_payment WHERE purchase_payment_date  BETWEEN '$from_date' AND '$to_date'$e_categorySql$s_nameSql$pay_modeSql$ref_noSql$addedBy";
//                                        $sqls = "SELECT COUNT(id) as count FROM purchase_return_payment";
//                                }
                ...
                <div class="basic-form" style="color: black;">
                    <form id="filter_form" autocomplete="off">
                        <div class="form-row">
                            ...
                            <!--                                <div class="form-group col-md-12">-->
                            <!--                                    <label>purchase_return_payment Id </label>-->
                            <!--                                    <input type="text"  class="form-control" placeholder="purchase_return_payment Id" id="purchase_payment_id" name="purchase_payment_id" style="border-color: #181f5a;color: black">-->
                            <!--                                </div>-->
                            <div class="form-group col-md-12">
                                ...
                                <!--                                    <input type="text"  class="form-control" placeholder="purchase_return_payment Category" id="e_category" name="e_category" style="border-color: #181f5a;color: black">-->
                            </div>
                            <div class="form-group col-md-12">
