...
<div class="dlabnav">
    <div class="dlabnav-scroll">
        <ul class="metismenu" id="menu">
            ...
            <?php
            if($_COOKIE['role'] == 'Super Admin'  || $_COOKIE['role'] == 'Market'|| $_COOKIE['role'] == 'Admin' || $_COOKIE['role'] == 'Service' || $_COOKIE['role'] == 'Accounts' ) {
                ?>
                <li>
                    <a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        <i class="fa-solid fa-code-compare"></i>
            ...
            if($_COOKIE['role'] == 'Super Admin' || $_COOKIE['role'] == 'Admin') {
                ...
                <li id="test1">
                    ...
                    <ul aria-expanded="false">
                        ...
                        if($_COOKIE['role'] == 'Super Admin'|| $_COOKIE['role'] == 'Admin') {
                            ?>
                            <li id="drop1"><a href="<?php echo $website; ?>/report/loan_report" id="link1"><i
                                            class="fa-solid fa-chart-bar"></i> Loan</a></li>
                            <li><a href="<?php echo $website; ?>/report/user_report"><i
                                            class="fa-solid fa-chart-bar"></i> User-Report</a></li>
                            <li><a href="<?php echo $website; ?>/report/not_visit"><i
                                            class="fa-solid fa-chart-bar"></i> Not-Visit-Report</a></li>
                            <li><a href="<?php echo $website; ?>/report/reschedule"><i
                                            class="fa-solid fa-chart-bar"></i> Reschedule-Report</a></li>
                            <li><a href="<?php echo $website; ?>/report/purchase_status"><i
                                            class="fa-solid fa-chart-bar"></i> Purchase Status</a></li>
                            <li><a href="<?php echo $website; ?>/report/bank_report"><i
                                            class="fa-solid fa-chart-bar"></i> Bank Report</a></li>
                            <li><a href="<?php echo $website; ?>/report/profit_loss"><i
                                            class="fa-solid fa-chart-bar"></i> Profit & Loss Report</a></li>
