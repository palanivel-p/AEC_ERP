...
<head>
    ...
    <title>Service Company Profile</title>
...
<div id="main-wrapper">
    ...
    <?php
    $header_name ="Service Company Profile";
    ...
    <div class="content-body">
        <div class="page-titles" style="margin-left: 21px;">
            <ol class="breadcrumb">
                ...
                <!--                <li class="breadcrumb-item active"><a href="javascript:void(0)">service Company Profile</a></li>-->
            </ol>
        </div>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Service Company Profile</h4>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-responsive-md" style="text-align: center;">
                            ...
                            <?php
                            if($product_id == "") {
                                $sql = "SELECT * FROM service_profile WHERE added_date  BETWEEN '$from_date' AND '$to_date' $addedBy ORDER BY id DESC LIMIT $start,10";
                            }
                            {
                                $sql = "SELECT * FROM service_profile WHERE added_date  BETWEEN '$from_date' AND '$to_date'  $addedBy ORDER BY id DESC LIMIT $start,10";
                            }
                            ...
                            <tr>
                                ...
                                <td> <?php echo $zone?> </td>
                                <td> <a href="service_view.php?service_id=<?php echo $row['service_profile_id'] ?>&service_type=<?php echo "contact_details" ?>"><span class="badge badge-pill badge-success">View</span></a></td>
                                <td> <a href="service_view.php?service_id=<?php echo $row['service_profile_id'] ?>&service_type=<?php echo "requirement_details" ?>"><span class="badge badge-pill badge-success">View</span></a></td>
                                <td> <a href="service_view.php?service_id=<?php echo $row['service_profile_id'] ?>&service_type=<?php echo "furnace_details" ?>"><span class="badge badge-pill badge-success">View</span></a></td>
                                <td> <a href="service_view.php?service_id=<?php echo $row['service_profile_id'] ?>&service_type=<?php echo "laddle_details" ?>"><span class="badge badge-pill badge-success">View</span></a></td>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item" style="cursor: pointer" href="profile.php?service_id=<?php echo $row['service_profile_id'] ?>&company_name=<?php echo $customer_name ?>">Add Company Details</a>
                                            <a class="dropdown-item" style="cursor: pointer" href="service_view.php?service_id=<?php echo $row['service_profile_id'] ?>&service_type=<?php echo "company_profile" ?>">Edit Company Detail</a>
                                            <a class="dropdown-item" data-toggle="modal" data-target="#career_list" style="cursor: pointer" onclick="editTitle('<?php echo $row['service_profile_id'];?>')">Edit</a>
<!--                                            <a class="dropdown-item" style="cursor: pointer" href="service_view.php?service_id=--><?php //echo $row['service_profile_id'] ?><!--&service_type=--><?php //echo "company_profile" ?><!--">Edit</a>-->
                                            <?php
                                            if($_COOKIE['role'] == 'Super Admin' || $_COOKIE['role'] == 'Service') {
                                                ?>
                                                <a class="dropdown-item" style="cursor: pointer" onclick="delete_model('<?php echo $row['service_profile_id'];?>')">Delete</a>
                                                <?php
                                            }
                                            ?>
                                        </div>
                        ...
                        <div class="col-12 pl-3" style="display: flex;justify-content: center;">
                            <nav>
                                <ul class="pagination pagination-gutter pagination-primary pagination-sm no-bg">
                                    ...
                                    if($product_id == "") {
                                        $sql = "SELECT COUNT(id) as count FROM service_profile WHERE added_date  BETWEEN '$from_date' AND '$to_date'$addedBy";
                                    }
                                    {
                                        $sql = "SELECT COUNT(id) as count FROM service_profile WHERE added_date  BETWEEN '$from_date' AND '$to_date'  $addedBy";
                                    }
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6" id="c_type">
                                        ...
                                        <select  class="form-control" id="assigned_to" name="assigned_to" style="border-color: #181f5a;color: black">
                                            <?php
                                            $sqlDevice = "SELECT * FROM `user` WHERE role = 'Service'";
        ...
        $.ajax({
            ...
            success: function(res){
                if(res.status=='success')
                {
                    ...
                    $("#old_pa_id").val(res.service_profile_id);
                    $("#service_id").val(res.service_profile_id);
