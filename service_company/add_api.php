...
if(isset($_POST['customer_name'])) {
    ...
    $service_profile_id = clean($_POST['service_id']);
...
//    $sqlValidateCookie="SELECT * FROM `user_details` WHERE panel_api_key='$api_key'";
    ...
    if (mysqli_num_rows($resValidateCookie) > 0) {
        ...
        //Furnace lining
        $sqlUpdate = "UPDATE service_profile SET service_profile_id = '$service_profile_id',customer_name = '$customer_name',material_type = '$material_type',location = '$location',monthly_production='$monthly_production',shift = '$shift' WHERE service_profile_id ='$service_profile_id'";
...
//        mysqli_query($conn, $sqlUpdate);
        ...
        for($gl=0;$gl<$countGoldLoans;$gl++) {
            ...
            $sqlInsertGLoan = "INSERT INTO `service_requirement`(`service_profile_id`, `product_name`, `category`, `supplier`, `qty`) 
                                           VALUES ('$service_profile_id','$glValuesAr[0]','$glValuesAr[2]','$glValuesAr[4]','$glValuesAr[6]')";
        ...
        $info = urlencode("Service Company Added");
