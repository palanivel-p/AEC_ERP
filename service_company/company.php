...
//    $sqlValidateCookie="SELECT * FROM `user_details` WHERE panel_api_key='$api_key'";
    ...
    if (mysqli_num_rows($resValidateCookie) > 0) {
        ...
        $sqlInsert = "INSERT INTO `service_profile`(`service_profile_id`, `customer_name`,`assigned_to`,`zone`,`added_date`,`added_by`) 
                                            VALUES ('','$customer_name','$assigned_to','$zone','$date','$added_by')";
