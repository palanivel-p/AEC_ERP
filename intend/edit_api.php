...
//        if (mysqli_num_rows($resValidate) > 0 || ($adjustment_id == $old_pa_id)) {
        ...
        $sqlUpdate = "UPDATE `intend` SET `intend_id`='$intend_id',`intend_date`='$intend_date',`notes`='$notes', `discount` = '$discount',`grand_total` = '$grand_total',`total_tax`='$totaltax' WHERE `intend_id`='$intend_id'";
