...
<div id="printPdf">
    <div class="table-container">
        <table style="background-color: #b5b5b5;text-align: center">
            <tbody>
            <tr>
                <td style="text-align: center"><img src="https://erp.aecindia.net/purchase_v1/AEC.png" height="80px"></td>
        ...
        <tbody>
              <tr>
                ...
                <tr>
                <td style="width:50%;text-align: left" rowspan="4">Name: '. $supplier_name.'<br>
        ...
        <tbody>
           <tr style="background-color: #ffab7d">
            ...
            <th rowspan="2">Total</th>
             ...
             <tr style="background-color: #ffab7d">
            <th style="width: 5px">Dis(%)</th>
            <th style="width: 9px">Dis Value</th>
            <th style="width: 9px">Tax (%)</th>
            <th style="width: 9px">Tax Value</th>
            </tr>';
            ...
            <td style="text-align: center"><span style="font-family: DejaVu Sans; sans-serif;">'.$currency_symbol.'</span>'. $unit_cost.'</td>
            <td>'. $discount.'</td>
            <td><span style="font-family: DejaVu Sans; sans-serif;">'.$currency_symbol.'</span>'. $discount_value.'</td>
            <td>'. $tax.'</td>
            <td><span style="font-family: DejaVu Sans; sans-serif;">'.$currency_symbol.'</span>'. $tax_value.'</td>
            <td><span style="font-family: DejaVu Sans; sans-serif;width: 10px;">'.$currency_symbol.'</span>'. $total.'</td>
            </tr>
            ...
            <td colspan="2" style="text-align: right"><span style="font-family: DejaVu Sans; sans-serif;">'.$currency_symbol.'</span>'.$totalAmount.'</td>
            </tr>
...
if (substr($tax, 0, 3) === 'IGS'){
    $data .= '
           <tr>
            ...
            <td colspan="2" style="text-align: right">(-)<span style="font-family: DejaVu Sans; sans-serif;">'.$currency_symbol.'</span>'.$totalDiscountValue.'</td>
            </tr>
            
        <tr>                
            <td colspan="1">Tax ('.$tax.')</td>
            <td colspan="2" style="text-align: right">(+)<span style="font-family: DejaVu Sans; sans-serif;">'.$currency_symbol.'</span>'.($totalTaxValue).'</td>
        </tr>';
} else {
    $data .= '
            <tr>
        ...
        <tr>        
            ...
            <td colspan="2" style="text-align: right">(+)<span style="font-family: DejaVu Sans; sans-serif;">'.$currency_symbol.'</span>'.($totalTaxValue/2).'</td>
        </tr>
        <tr>         
...
$data .= '
            ...
            <td colspan="2" style="text-align: right"><span style="font-family: DejaVu Sans; sans-serif;">'.$currency_symbol.'</span>'.$grand_total.'</td>
            </tr>
            <tr>
    
            <td colspan="1">Payment Made</td>
            <td colspan="2" style="text-align: right"><span style="font-family: DejaVu Sans; sans-serif;">'.$currency_symbol.'</span>'.$totalAmountSS.'</td>
            </tr>
            
             <tr>
            <td colspan="1">Balance Due</td>
            <td colspan="2" style="text-align: right"><span style="font-family: DejaVu Sans; sans-serif;">'.$currency_symbol.'</span>'.$balance_amount.'</td>
            </tr>
