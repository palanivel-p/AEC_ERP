...
//                                                    $discount_s=  str_replace("%","",$discount1);
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" class="form-control" placeholder="Material Despatch " id="material" name="material" value="<?php echo $material?>" style="border-color: #181f5a;color: black">
                                </div>
                                <div class="form-group col-md-6">
                                    <label>Transport</label>
                                    <input type="text" class="form-control" placeholder="Transport" id="transport" name="transport" value="<?php echo $transport?>" style="border-color: #181f5a;color: black">
                                </div>
