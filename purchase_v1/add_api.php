...
if(isset($_POST['supplier'])&&isset($_POST['purchase_date'])) {
    ...
    if (mysqli_num_rows($resValidateCookie) > 0) {
        ...
        $sqlInsert = "INSERT INTO `purchase_v1`(`purchase_id`,`intend_id`,`supplier`,`purchase_date`,`discount`,`grand_total`,`payment_status`,`notes`,`status`,`material_date`,`payment_terms`,`currency_id`,`due_date`,`total_tax`) 
                                            VALUES ('','$intend_id','$supplier_id','$purchase_date','$discount','$grand_total','$payment_status','$notes','$status','$material','$payment_terms','$currency','$d_date','$totaltax')";
        ...
        $sqlUpdate = "UPDATE purchase_v1 SET purchase_id = '$purchase_id',invoice_no='$invoice_no' WHERE id ='$ID'";
...
//            $discount = str_replace('%', '', $discount);
            ...
            $sqlInsersts = "INSERT INTO purchase_details (purchase_details_id,product_id,product_name,unit,unit_cost, stock,Stock_count ,discount,dis_symbl, tax, sub_total,qty,tax_value,discount_value,discount_type,productDesc) 
                    VALUES ('','$productId','$productName','$unit', '$netUnitCost', '$stockValue','$stock_add', '$discount','$persymbl', '$tax', '$subtotal','$quantity','$tax_value','$discount_value','$symbl','$productDesc')";
            ...
            $sqlUpdate = "UPDATE purchase_details SET purchase_details_id = '$purchase_details_id',purchase_id='$purchase_id',intend_id ='$intend_id' WHERE id ='$ID'";
            mysqli_query($conn, $sqlUpdate);
