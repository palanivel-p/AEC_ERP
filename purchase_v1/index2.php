...
//                                                    $taxValuess = intval($unit_cost)*$qty;
//                                                    $taxValues = $taxValuess*(18/100);
...
//                                                    $product_unit =  $rowProduct['product_unit'];
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <span id="<?php echo $product_id.'_tax' ?>"><?php echo $tax?></span>
                                                                <span id="<?php echo $product_id.'_descrip' ?>"></span>

                                                            </td>
                                                            <td><span id="<?php echo $product_id.'_taxValue' ?>"><?php echo round($taxValues)?></span></td>
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <select data-search="true" class="form-control tail-select w-full" id="payment_status" name="payment_status" style="border-color: #181f5a;color: black">
                                        <option value='4'>Odered</option>
                                        <option value='1'>Received</option>
                                        <option value='2'>Partially Pending</option>
                                ...
                                <div class="form-group col-md-4">
                                    <label>Material Despatch </label>
                                    <input type="text" class="form-control" placeholder="Material Despatch " id="material" name="material" style="border-color: #181f5a;color: black">
                                </div>
                                <div class="form-group col-md-6">
                                    <label>Transport</label>
                                    <input type="text" class="form-control" placeholder="Transport" id="transport" name="transport" style="border-color: #181f5a;color: black">
                                </div>
...
<script>
    ...
    function editTitle(data,quantity,discounts,units) {
        ...
        var edit_model_title = "Purchase - "+data;
    ...
    var intend_ids ='<?php echo $intend_id ?>';
    ...
    function tableBuild(product_id,product_price,product_name,product_stock,product_tax,product_unit) {
        ...
        if(!gArray.includes(product_id)) {
            ...
            // const descrip = document.createElement("td");
            // descrip.setAttribute("id", `${product_id}_descrip`);
            // descrip.setAttribute("display", `none`);
            // descrip.innerHTML = '';
