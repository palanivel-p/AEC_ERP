                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-responsive-md" style="text-align: center;">
                            ...
                            <?php
                               $sql = "SELECT * FROM `intend` WHERE request = 0 ORDER BY id DESC LIMIT $start,10";
//                            if($email == "" && $u_code == "" && $mobile== "" && $u_name == "") {
//                                $sql = "SELECT * FROM Request  ORDER BY id  LIMIT $start,10";
//                            }
//                            else {
//                                $sql = "SELECT * FROM Request WHERE id > 0 $emailSql$mobileSql$uCodeSql$uNameSql ORDER BY id  LIMIT $start,10";
//                            }
...
<!--                                <td> <a href="invoice.php?intend_id=--><?php //echo $intend_id ?><!--"><span class="badge badge-pill badge-primary">View</span></a></td>-->
                                <td class="text-center">
                                    <div class="dropdown">
                                        <a href="<?php echo $website?>/intend_request/show_file.php?intend_id=<?php echo $row['intend_id']?>"
                                           class="btn btn-primary shadow btn-xs sharp me-1"><i class="fa fa-eye"></i></a>
                                    </div>
                                </td>
                                <td> <button type="button" class="btn btn-succes" id="verify_btn" onclick= "approve('<?php echo $intend_id;?>')" style="background-color: green; color: white;">Approve</button></td>
                        ...
                        <div class="col-12 pl-3" style="display: flex;justify-content: center;">
                            <nav>
                                <ul class="pagination pagination-gutter pagination-primary pagination-sm no-bg">
                                    ...
                                    $sql = 'SELECT COUNT(id) as count FROM intend WHERE request = 0';
                                    $result = mysqli_query($conn, $sql);
