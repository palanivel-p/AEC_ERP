            ...
            <div class="card">
                <div class="card-body">
                    <div class="card-header">
                        <h4 class="card-title">View /Request Details</h4>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <table class="table table-bordered" style="text-align: center;">
                                    ...
                                    <tr>
                                        <th><strong>#</strong></th>
                                        <th class="table_head"><strong>Purchase Id</strong></th>
                                    ...
                                    $sql = "SELECT * FROM purchase_details WHERE purchase_id = '$request_id'  ORDER BY id DESC LIMIT $start, 10";
                                    ...
                                    if (mysqli_num_rows($result)>0) {
                                        ...
                                        while($row = mysqli_fetch_assoc($result)) {
                                            ...
                                            $sqlIntend = "SELECT * FROM `purchase` WHERE `purchase_id`='$request_id'";
                                            ...
                                            <tr>
                                                ...
                                                <td class="table_data"><?php echo $request_id?></td>
                                                <td class="table_data"><?php echo $product_name?></td>
                                                <td class="table_data"> <?php echo $qty?> </td>
                                                <td class="table_data"> <?php echo $unit_cost?> </td>
                                                <td class="table_data"> <?php echo $stock_qty?> </td>
                                                <td class="table_data"> <?php echo $supplier_name?> </td>
