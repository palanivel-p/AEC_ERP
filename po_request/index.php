        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">PO Request List</h4>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-responsive-md" style="text-align: center;">
                            ...
                            <?php
                               $sql = "SELECT * FROM `purchase` WHERE request = 0 ORDER BY id DESC LIMIT $start,10";
//                            if($email == "" && $u_code == "" && $mobile== "" && $u_name == "") {
//                                $sql = "SELECT * FROM PO Request  ORDER BY id  LIMIT $start,10";
//                            }
//                            else {
//                                $sql = "SELECT * FROM PO Request WHERE id > 0 $emailSql$mobileSql$uCodeSql$uNameSql ORDER BY id  LIMIT $start,10";
//                            }
...
//                            }
                            ...
                            if (!empty($added_bys)) {
                                $sqlUser = "SELECT `f_name` FROM `user` WHERE `user_id`='$added_bys'";
                                $resUser = mysqli_query($conn, $sqlUser);
...
<!--                                <td> <a href="invoice.php?intend_id=--><?php //echo $purchase_id ?><!--"><span class="badge badge-pill badge-primary">View</span></a></td>-->
                                <td class="text-center">
                                    <div class="dropdown">
                                        <a href="<?php echo $website; ?>/po_request/show_file.php?request_id=<?php echo $purchase_id?>"
                                           class="btn btn-primary shadow btn-xs sharp me-1"><i class="fa fa-eye"></i></a>
                                    </div>
                                </td>
                                <td> <button type="button" class="btn btn-succes" id="verify_btn" onclick= "approve('<?php echo $purchase_id;?>')" style="background-color: green; color: white;">Approve</button></td>
                        ...
                        <div class="col-12 pl-3" style="display: flex;justify-content: center;">
                            <nav>
                                <ul class="pagination pagination-gutter pagination-primary pagination-sm no-bg">
                                    ...
                                    $sql = 'SELECT COUNT(id) as count FROM purchase WHERE request = 0';
                                    $result = mysqli_query($conn, $sql);
                            ...
                            <form id="career_form" autocomplete="off">
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="hidden" class="form-control"  id="PO Request_id" name="PO Request_id">
                                    </div>
                                    <div class="form-group col-md-6">
                        ...
                        success: function(res){
                            if(res.status=='success')
                            {
                                Swal.fire(
                                    ...
                                    .then((value) => {
                                        // window.window.location.reload();
                                        window.location.href = "<?php echo $website; ?>/po_request/";
