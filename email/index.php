...
if (mysqli_num_rows($result)>0) {
    ...
    while($row = mysqli_fetch_assoc($result)) {
        ...
        $data .= '
            ...
            <td><span style="font-family: DejaVu Sans; sans-serif;">'.$currency_symbol.'</span>'. $unit_cost.'</td>
            <td>'. $discount.'</td>
            ...
            <td><span style="font-family: DejaVu Sans; sans-serif;">'.$currency_symbol.'</span>'. $total.'</td>
            </tr>
...
//   $mail->SMTPDebug = 2; // 0 = off (for production use) - 1 = client messages - 2 = client and server messages
    ...
    $mail->addAddress($emailTo1, $emailToName);
    $mail->addAddress($emailTo2, $emailToName);
